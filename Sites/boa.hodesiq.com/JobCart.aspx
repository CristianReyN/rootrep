                            ...
                            <cswc:JobCartGridView
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Job name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <a title="click for job details" href='JobDetails.aspx?SearchPage=Sp&amp;JobId=<%# Eval("JobId") %>'>
                                                <%# Eval("Title").ToString()%>
                                            </a>
                                            <asp:HiddenField ID="hdnJobTitle" runat="server" Value='<%# Eval("Title").ToString() %>' />
                                            <asp:HiddenField ID="hdnURL" runat="server" Value='<%# Eval("URL").ToString() %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Apply" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
