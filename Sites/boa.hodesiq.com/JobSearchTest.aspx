<%@ Page AutoEventWireup="true" CodeFile="JobSearchTest.aspx.cs" Inherits="JobSearchTest"
						...
						<td colspan="3">
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>	
									...
									<td width="10">&nbsp;</td>
									<td align="left" valign="top"><asp:HyperLink runat="server" ID="lnkAdvanceSearch" NavigateUrl="~/AdvanceSearchTest.aspx" Text="Advanced search" CssClass="p" ToolTip="Advanced search" /></td>
									<td width="10">&nbsp;</td>
