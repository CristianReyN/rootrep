<%@ Page Title="Bank of America | Careers | Campus Recruiting | Meet Our People | John-William's Profile" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-meet-our-people-profile-John-William.aspx.cs" Inherits="campus_meet_our_people_profile_John_William" %>
...
<div id="profiles"> 
  <h1>Our Analysts</h1>
  <div id="article"> 
    <div class="content-profiles"> <img src="images/campus/profiles/photo-John-William.jpg" width="167" height="168" alt="John-William" /> 
      <div class="info-profiles"> 
        <h2>John-William</h2>
        <p>Senior Specialist</p>
        <p>Global Wealth and Investment Management Analyst, London</p>
        <h3>Education:</h3>
        <p>Undergrad &ndash; Newcastle University</p>
    ...
    <p>I am currently in the Global Wealth and Investment Management (GWIM) Graduate 
      ...
      a financial adviser. Having spent the last six months learning about financial 
      products and their suitability for different types of private clients, I 
      am now working with financial advisers and getting hands-on experience working 
      with and assisting clients, so that I can eventually manage my own clients. 
    </p>
    <h4>What is the most challenging part of your job?</h4>
    <p>The biggest challenge is actually the part of my job which I enjoy the 
      most. No two private clients are the same and the solutions they require 
      are constantly changing and evolving. The challenge is to stay up to date 
      with the latest product, regulatory, and economic changes so that the solutions 
      provided are the best and the most suitable. </p>
    <h4>What attracted you to Bank of America?</h4>
    <p>The bank has a long history of providing excellent training to the graduates 
      it takes and has always seen the value of developing talent. As someone 
  ...
  <div id="aside"> 
    ...
    <ul>
      ...
      <li><a href="campus-meet-our-people-profile-Ken.aspx">Next profile</a></li>
      <li><a href="campus-meet-our-people-profile-Hira.aspx">Previous profile</a></li>
    </ul>
  </div>
  <div id="red-footer"> 
...
<script language='javascript1.1' type='text/javascript'>
    //<!—
    cmCreatePageviewTag('career:Content:Campus_Recruiting;campus-meet-our-people-profile-john-williams', null, null, 'career:Content:Campus_Recruiting', false, false, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null);
    //-->
</script>  
</asp:Content>
