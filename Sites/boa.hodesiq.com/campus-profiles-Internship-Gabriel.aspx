<%@ Page Title="Bank of America | Careers | Campus Recruiting | Meet Our People | Gabriel's Internship Profile" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-profiles-Internship-Gabriel.aspx.cs" Inherits="campus_profiles_Internship_Gabriel" %>
...
<div id="profiles"> 
  <h1>Our Interns</h1>
  <div id="article"> 
    <div class="content-profiles"> <img src="images/campus/profiles/photo-Gabriel.jpg" width="167" height="168" alt="Gabriel" /> 
      <div class="info-profiles"> 
        <h2>Gabriel</h2>
        <p>Analyst</p>
        <p>Corporate and Investment Banking Analyst Program, Hong Kong</p>
        <h3>Education:</h3>
        <p>Undergrad &ndash; University of Pennsylvania, Wharton</p>
    ...
    <p>Speak to as many people as possible about their experiences. This is so 
      that you will be equipped to make an informed decision as to which specific 
      division at Bank of America might be most aligned with your interests and 
      career plans. </p>
    ...
    <p>I was a summer analyst back in 2007, and I had the opportunity to work 
      on several live transactions, which gave me much insight into banking. The 
      program was very organized and I learned a lot during the course of the 
      ten weeks. On the whole, it was a very fruitful experience and it made me 
      decide to pursue investment banking as a full-time career. </p>
    <h4>What other activities do you enjoy outside of your work day?</h4>
    <p>Outside of work, I enjoy outdoor activities like hiking and scuba diving. 
  ...
  <div id="aside"> <a href="campusrecruiting/career_fit_tool.asp" name="Find_Your_Fit"><img src="images/campus/btn-careerfinder.jpg" width="179" height="66" alt="Career Finder: Come as you are. We've got a career to fit." /></a> 
    ...
    <ul>
      ...
      <li><a href="campus-profiles-Internship-Stanley.aspx">Next profile</a></li>
      <li><a href="campus-profiles-Internship-Dong.aspx">Previous profile</a></li>
    </ul>
  </div>
  <div id="red-footer"> 
...
<script language='javascript1.1' type='text/javascript'>
    //<!—
    cmCreatePageviewTag('career:Content:Campus_Recruiting;campus-profiles-internship-gabriel', null, null, 'career:Content:Campus_Recruiting', false, false, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null);
    //-->
</script>
