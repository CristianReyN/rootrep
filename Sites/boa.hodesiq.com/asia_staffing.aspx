<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="asia_staffing.aspx.cs" Inherits="asia_staffing" 
...
<asp:Content ID="Main" ContentPlaceHolderID="Main" runat="Server">
    ...
    <h1 class="hidden">
        Global Careers - Staffing</h1>
    <table summary="Global Careers - Staffing" width="366" border="0" cellspacing="0"
        cellpadding="0">
        <tr>
            <td width="366" align="left" valign="top">
                ...
                <p>
                    Bank of America strives to identify and select the best candidate for each role.
                    As part of our assessment process, we use competency based interviews to measure
                    key aptitudes, attributes and values that an individual must demonstrate to be successful
                    in the job. The number of interviews will vary by role and line of business.</p>
            </td>
        </tr>
    </table>
</asp:Content>
                ...
                <div style="border: 1px solid #e8e8e9; margin: 1px 0px 1px 0px; padding: 0px 0px 6px 0px;">
                    ...
                    <div style="padding: 0px 0px 0px 4px;">
                        <table width="190" border="0" cellspacing="0" cellpadding="0" align="top">
                            ...
                            <tr>
                                <td height="26" align="left" valign="middle" style="background-image:url(images/dotted.gif); background-position:left top; background-repeat:repeat-x;">
...
<script language='javascript1.1' type='text/javascript'>
    //<!—
    cmCreatePageviewTag('career:Tool:Regions;asia-staffing', null, null, 'career:Tool:Regions', false, false, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null);
    //-->
</script>
</asp:Content>
