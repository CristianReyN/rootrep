<%@ Page Title="Bank of America | Careers | Campus Recruiting | Meet Our People | Louise's Profile" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-meet-our-people-profile-Louise.aspx.cs" Inherits="campus_meet_our_people_profile_Louise" %>
...
<div id="profiles"> 
  <h1>Our Analysts</h1>
  <div id="article"> 
    <div class="content-profiles"> <img src="images/campus/profiles/photo-Louise.jpg" width="167" height="168" alt="Louise" /> 
      <div class="info-profiles"> 
        <h2>Louise</h2>
        <p>Senior Specialist</p>
        <p>Chief Financial Office Analyst Program, Hong Kong</p>
        <h3>Education:</h3>
        <p>Undergrad &ndash; Schulich School of Business</p>
        <p>Degree &ndash; International BBA</p>
      </div>
    </div>
...
reconciliation; and market-to-market valuation verification
and monitoring.</p>
    
	<h4>What is the most challenging part of your job?</h4>
    <p>The most challenging part of this job is that it requires me to touch
base with almost every other department related to the trading
business: trading desk; price valuation group; settlement team;
core finance; and technology. Familiarity with the responsibility
scope and general work flow of all these counterparties is a must.</p>
    
	<h4>I remain at Bank of America because...?</h4>
    <p>I like the warm and accepting culture of my team. People come
from a vast variety of backgrounds, but we learn to leverage
...
culture where status quo is questioned and challenged.</p>
  ...
  <div id="aside"> <a href="campusrecruiting/career_fit_tool.asp"><img src="images/campus/btn-careerfinder.jpg" width="179" height="66" alt="Career Finder: Come as you are. We've got a career to fit." /></a> 
    ...
    <ul>
      ...
      <li><a href="campus-meet-our-people-profile-Scott.aspx">Next profile</a></li>
      <li><a href="campus-meet-our-people-profile-Lip-Jin.aspx">Previous profile</a></li>
    </ul>
  </div>
  <div id="red-footer"> 
...
<script language='javascript1.1' type='text/javascript'>
    //<!—
    cmCreatePageviewTag('career:Content:Campus_Recruiting;campus-meet-our-people-profile-louise', null, null, 'career:Content:Campus_Recruiting', false, false, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null);
    //-->
</script> 
</asp:Content>
