...
<%	If mpage = "lob" And spage = "lobcss" Then %>
				...
				<li class="tertiary"<% if tpage = "lobgr" then Response.Write " style=""background: #eaf1f7;""" end if %>><div><a href="lobgr.asp" class="sbtxt" title="Global Risk Management" onfocus="this.className='sbtxt-over';" onblur="this.className='sbtxt';">Global Risk Management</a></div>
				</li>
<%	End If %>
