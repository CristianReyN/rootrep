<%@ Page Title="Bank of America | Careers | Campus Recruiting | Meet Our People | Rachel's Profile" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-meet-our-people-profile-Rachel.aspx.cs" Inherits="campus_meet_our_people_profile_Rachel" %>
    ...
    <div id="article">
        ...
        <div class="content-profiles">
            ...
            <img src="images/campus/profiles/photo-Rachel.jpg" width="167" height="168" alt="Rachel" />
                ...
                <h2>Rachel</h2>
                <p>Associate</p>
                <p>Supply Chain Management, Charlotte, NC</p>
                
                <h3>Education:</h3>
                <p>Undergrad &ndash; W.P. Carey School of Business at Arizona State University</p>
...
over 1.8MM Bank of America documents from off-site storage locations
across the nation.</p>

<p>Also, I am responsible for managing a certified women-owned supplier
through the bank’s supplier management routines. The project will help
increase inventory visibility and aligns with my team’s goal to create a
world-class records management program.</p>

<h4>What is the most challenging part of your job?</h4>
<p>Managing a team of peers has been my greatest challenge this year.
I’ve learned that it’s about more than delegating responsibility and
setting timelines. You have to take the time to get to know your team
and what motivates each team member to get the job done.</p>

<h4>What attracted you to Bank of America?</h4>
<p>The rotational opportunity to have multiple experiences and coaching
with exposure across the businesses drew me in. My school work
...
and Kiwanis.</p>
    ...
    <div id="aside">
        ...
        <li><a href="campus-Americas-associate-profiles.aspx">Back to profile list</a></li>
      	<li><a href="campus-meet-our-people-profile-Tyler.aspx">Next profile</a></li>
      	<li><a href="campus-meet-our-people-profile-Pepe.aspx">Previous profile</a></li>
        </ul>
...
<script language='javascript1.1' type='text/javascript'>
    //<!—
    cmCreatePageviewTag('career:Content:Campus_Recruiting;campus-meet-our-people-profile-rachel', null, null, 'career:Content:Campus_Recruiting', false, false, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null);
    //-->
</script>
</asp:Content>
