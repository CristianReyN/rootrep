<%@ Page Title="Bank of America | Careers | Campus Recruiting | Opportunities | EMEA Pre-University" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-EMEA-pre-university.aspx.cs" Inherits="campus_EMEA_pre_university" %>
...
<div id="maincontent"> 
                <div id="article"> 
                  ...
                  <p>Events are held in Spring, Summer and Autumn. Please register online via <a href="CampusEvents.aspx?region=2">campus events</a>.</p>
                  
                  <h2 class="questions">Pre-university opportunities</h2>
                  <h3>Banking Uncovered</h3>
                  <p>It’s never too early to think about your future, and Bank of America runs “Banking Uncovered,” a one-day insight programme for A-level students in Year 12.</p>
                
                  <p>The programme is designed to demystify the industry and encourage students to consider pursuing careers in investment banking. It’s hosted in the London office and students have the opportunity to meet and question recent graduates on career opportunities and the skills required for different roles.</p>
				    ...
				    <div class="rnt">        
				        <div class="rnb">            
				            <div class="inner" id="showHTML">                
				                ...
				                <div class="iwrap ss"> <script language="javascript" type="text/javascript">				                                           document.write(displayIcon("3", "Bank of America | Careers | Campus Recruiting | Opportunities | EMEA Pre-University", "", "", "", "", "", "", "", "Bank of America | Careers | Campus Recruiting | Opportunities | EMEA Pre-University", "", "career:Content:Campus_Recruiting;campus-emea-pre-university", "1", ""));</script></div>
				                <div class="iwrap ss"><script language="javascript" type="text/javascript">				                                          document.write(displayIcon("1", "Bank of America | Careers | Campus Recruiting | Opportunities | EMEA Pre-University", "", "", "", "", "", "", "", "", "", "career:Content:Campus_Recruiting;campus-emea-pre-university", "1", ""));</script></div>                   
				                <div class="iwrap ss"><script language="javascript" type="text/javascript">				                                          document.write(displayIcon("2", "Bank of America | Careers | Campus Recruiting | Opportunities | EMEA Pre-University", "", "", "", "", "", "Bank of America | Careers | Campus Recruiting | Opportunities | EMEA Pre-University", "", "", "", "career:Content:Campus_Recruiting;campus-emea-pre-university", "1", ""));</script></div>            
...
<script language='javascript1.1' type='text/javascript'>
    //<!—
    cmCreatePageviewTag('career:Content:Campus_Recruiting;campus-emea-pre-university', null, null, 'career:Content:Campus_Recruiting', false, false, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null);
    //-->
</script>    
</asp:Content>
