 ...
 <div id="mop-maincontent">
	<div id="article">
    	<h1>Meet Our People</h1>
	 	...
	 	<div class="featured-profile">
            ...
            <div class="mop-profile">
            		<img src="images/campus/ico-mop-Patricia.jpg" width="165" height="100" alt="Patricia" />
            		<h3>Patricia</h3>
            <p>Global Investment Banking Analyst Program</p>
            <div class="profile-content-links">
                <p class="profile-link"><a href="campus-video.aspx?id=13" class="video" title="View Patricia's Profile">View Profile</a></p>
			    <p class="mop-transcript"><a href="campusrecruiting/video/Patricia/transcript.asp" class="transcript" title="View Patricia's Transcript">View Transcript</a></p>
             </div>
            </div>
		...
		<div class="featured-profile">
            ...
            <div class="mop-profile">
            		<img src="images/campus/ico-mop-Narinder.jpg" alt="Narinder" />
            		<h3>Narinder</h3>
            <p>Global Markets Associate Program</p>
            <div class="profile-content-links">
                <p class="profile-link"><a href="campus-video.aspx?id=7" class="video" title="View Narinder's Profile">View Profile</a></p>
			    <p class="mop-transcript"><a href="campusrecruiting/video/Narinder/transcript.asp" class="transcript" title="View Narinder's Transcript">View Transcript</a></p>
		    </div>
            </div>
           ...
           <div class="featured-profile-intern">
				...
				<div class="mop-profile">
						<img src="images/campus/ico-mop-Leonard.jpg" alt="Leonard" />
						<h3>Leonard</h3>
				<p>Global Treasury Solutions Associate Program</p>
				<div class="profile-content-links">
				    <p class="profile-link"><a href="campus-video.aspx?id=6" class="video" title="View Leonard's Profile">View Profile</a></p>
				    <p class="mop-transcript"><a href="campusrecruiting/video/Leonard/transcript.asp" class="transcript" title="View Leonard's Transcript">View Transcript</a></p>
				</div>
				</div>
