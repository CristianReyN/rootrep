<%@ Page Title="Bank of America | Careers | Campus Recruiting | Meet Our People | Pepe's Profile" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-meet-our-people-profile-Pepe.aspx.cs" Inherits="campus_meet_our_people_profile_Pepe" %>
...
<div id="profiles"> 
  ...
  <div id="article"> 
    <div class="content-profiles"> <img src="images/campus/profiles/photo-Pepe.jpg" width="167" height="168" alt="Pepe" /> 
      <div class="info-profiles"> 
        <h2>Pepe</h2>
        <p>Associate</p>
        <p>Corporate and Investment Banking Associate Program, New York, NY</p>
        <h3>Education:</h3>
        <p>Undergrad &ndash; Universidad Iberoamericana, Mexico, Chemical Engineering</p>
    ...
    <p>I work as an associate in the Healthcare Investment Banking Group in New 
      ...
      group advises clients on capital raising, including debt and equity products, 
      as well as merger &amp; acquisitions advisory services. Additionally, I am responsible 
      for day-to-day execution on live transactions. </p>
    <h4>What was the best deal/project you worked on?</h4>
    <p>I worked on a recently announced multibillion dollar sell-side. This was 
      a great experience for me as I was involved on this transaction since pitching 
      the idea to the client almost a year before it was announced. I was able 
      to contribute to the process and had very close interaction with our client 
      on a day-to-day basis. </p>
    <h4>What is the best thing about living and working in your location? </h4>
    <p>Working in investment banking and living in New York is a great combination. 
      New York is the financial capital of the world, and being here at the beginning 
  ...
  <div id="aside"> <a href="campusrecruiting/career_fit_tool.asp" name="Find_Your_Fit"><img src="images/campus/btn-careerfinder.jpg" width="179" height="66" alt="Career Finder: Come as you are. We've got a career to fit." /></a> 
    ...
    <ul>
      ...
      <li><a href="campus-meet-our-people-profile-Rachel.aspx">Next profile</a></li>
      <li><a href="campus-meet-our-people-profile-Nisheet.aspx">Previous profile</a></li>
    </ul>
  </div>
  <div id="red-footer"> 
...
<script language='javascript1.1' type='text/javascript'>
    //<!—
    cmCreatePageviewTag('career:Content:Campus_Recruiting;campus-meet-our-people-profile-pepe', null, null, 'career:Content:Campus_Recruiting', false, false, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null);
    //-->
</script>
