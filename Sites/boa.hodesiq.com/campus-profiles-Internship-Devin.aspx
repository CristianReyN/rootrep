<%@ Page Title="Bank of America | Careers | Campus Recruiting | Meet Our People | Devin's Internship Profile" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-profiles-Internship-Devin.aspx.cs" Inherits="campus_profiles_Internship_Devin" %>
...
<div id="profiles"> 
  ...
  <div id="aside"> <a href="campusrecruiting/career_fit_tool.asp" name="Find_Your_Fit"><img src="images/campus/btn-careerfinder.jpg" width="179" height="66" alt="Career Finder: Come as you are. We've got a career to fit." /></a> 
    ...
    <ul>
      ...
      <li><a href="campus-profiles-Internship-Jennifer.aspx">Next profile</a></li>
      <li><a href="campus-profiles-Internship-Bhavin.aspx">Previous profile</a></li>
    </ul>
  </div>
  <div id="red-footer"> 
...
<script language='javascript1.1' type='text/javascript'>
    //<!—
    cmCreatePageviewTag('career:Content:Campus_Recruiting;campus-profiles-internship-devin', null, null, 'career:Content:Campus_Recruiting', false, false, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null);
    //-->
</script>
