...
If isNull(session.Contents("sendresume_count")) Or trim(session.Contents("sendresume_count")) = "" Then
	Const ForReading = 1
	Dim fso, f, ts, scount, count, strPath, strFilePath
	strPath=server.MapPath("/")
	strFilePath = strPath&"\includes\stat\sendresume"
...
'Response.write scount
	...
	f.Write (count) 
	f.Close
	session.Contents("sendresume_count") = "Yes"
End If
