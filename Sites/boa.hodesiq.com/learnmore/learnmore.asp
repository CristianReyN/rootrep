...
if ( hasRequestedVersion ) {
   ...
   document.write('<param name="movie" value="faq_ria.swf" />');
   document.write('<param name="quality" value="high" />');
   document.write('<param name="wmode" value="transparent" />');
   document.write('<param name="bgcolor" value="#ffffff" />');
   document.write('<embed src="faq_ria.swf" wmode="transparent" quality="high" bgcolor="#ffffff" width="152" height="300" name="faq" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />');
...
<object tabindex="0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="152" height="300" id="faq" align="middle" title="Frequently Asked Questions Animation">
	...
	<param name="movie" value="faq_ria.swf" />
	<param name="quality" value="high" />
	<param name="wmode" value="transparent" />
	<param name="bgcolor" value="#ffffff" />
<embed src="faq_ria.swf" wmode="transparent" quality="high" bgcolor="#ffffff" width="152" height="300" name="faq" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
</object>
</noscript>
			</td></tr>
