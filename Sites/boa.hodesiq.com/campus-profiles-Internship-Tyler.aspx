<%@ Page Title="Bank of America | Careers | Campus Recruiting | Meet Our People | Tyler's Internship Profile" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-profiles-Internship-Tyler.aspx.cs" Inherits="campus_profiles_Internship_Tyler" %>
...
<div id="profiles"> 
  ...
  <div id="aside"> <a href="campusrecruiting/career_fit_tool.asp" name="Find_Your_Fit"><img src="images/campus/btn-careerfinder.jpg" width="179" height="66" alt="Career Finder: Come as you are. We've got a career to fit." /></a> 
    ...
    <ul>
      ...
      <li><a href="campus-profiles-Internship-Pepe.aspx">Previous profile</a></li>
    </ul>
  </div>
  <div id="red-footer"> 
