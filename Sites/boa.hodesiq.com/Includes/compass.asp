...
'				q,question number,question title,question weight
	...
	call addQuestion(group,q)
	call createQuestion(q,6,"Rotational (A structured program moving you through different positions within a group)","I am more interested in rotational",1)
	call addQuestion(group,q)
	call createQuestion(q,7,"Either","I am more interested in either direct-hire or rotational",1)
	call addQuestion(group,q)
