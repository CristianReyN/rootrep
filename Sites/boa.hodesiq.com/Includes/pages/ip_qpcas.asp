		<a name="skipmaincontent"></a><H1 style="margin: 0px <%=right_margin%>px 0px <%=left_margin_0%>px; padding: 0px;">Quality &amp; Productivity Change Analyst Internship</H1>
...
<p style="margin: 0px 0px 12px 0px;">
Quality &amp; Productivity Change Analyst Interns will participate in a program that is designed to foster teamwork, networking and accelerated development, with responsibilities that include:
</p>
<ul>
	<li>Gaining broad exposure to various lines of business by working closely with business executives to effectively lead, train, and coach quality activities that will achieve breakthrough productivity and customer satisfaction improvements</li>
...
<ul>
	...
	<li>Developed interpersonal skills</li>
	<li>High levels of motivation and self-direction</li>
	<li>Desire to learn about technology and the financial services industry</li>
	<li>Strong organizational, critical thinking and problem-solving skills</li>
