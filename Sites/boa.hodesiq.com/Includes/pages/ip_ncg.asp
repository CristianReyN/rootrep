		<a name="skipmaincontent"></a><H1 style="margin: 2px 0px 0px 0px;">Network Computing Group Internship Program</H1>
...
<ul>
	...
	<li>Analyzing, tracking and troubleshooting performance of assigned systems or networks to ensure that all information processing and delivery requirements are met</li>
	...
	<li>Providing project management support related to process improvement in technology</li>
...
<ul>
	...
	<li>Technical skills, including knowledge of several of the following: UNIX, Windows NT/2000, network architecture, databases, desktop and server hardware, information security concepts and technologies</li>
	<li>Developed project management skills and financial industry knowledge</li>
