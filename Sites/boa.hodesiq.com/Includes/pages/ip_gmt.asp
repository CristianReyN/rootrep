		<a name="skipmaincontent"></a><H1 style="margin: 0px <%=right_margin%>px 0px <%=left_margin_0%>px; padding: 0px;">Global Markets Technology Summer Analyst</H1>
...
<p style="margin: 0px 0px 3px 0px;">Additionally, all Global Markets Technology summer analysts are responsible for:</p>
<ul style="margin-top: 0px;">
...
<ul>
	...
	<li>Ability to multi-task and work effectively both individually and as part of a team in a fast-paced environment</li>
