		<a name="skipmaincontent"></a><H1 style="margin: 2px 0px 0px 0px;">Corporate Workplace Analyst Internship</H1>
...
<p style="margin: 0px 0px 12px 0px;">
The Corporate Workplace Analyst Intern, depending on assignment, may take on roles and responsibilities such as:
</p>
<ul>
	...
	<li>Applying financial, demographic and modeling tools to aid in the development of real estate portfolio strategies that enhance investment returns and minimize risk levels</li>
...
<ul>
	...
	<li>Dealing with Ambiguity - Can effectively cope with change, and comfortably handle risk and uncertainty</li>
</ul>
