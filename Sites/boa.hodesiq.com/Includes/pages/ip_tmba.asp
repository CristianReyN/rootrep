		<a name="skipmaincontent"></a><H1 style="margin: 0px <%=right_margin%>px 0px <%=left_margin_0%>px; padding: 0px;">Technology MBA - Leadership Rotational Program</H1>
...
<ul>
	...
	<li>Ability to learn the organizational structure and the formal/informal workings of the company</li>
...
<ul>
	...
	<li>Ability to succeed in a fast-paced and collaborative environment</li>
