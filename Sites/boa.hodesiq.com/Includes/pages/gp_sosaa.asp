		<a name="skipmaincontent"></a><H1 style="margin: 0px <%=right_margin%>px 0px <%=left_margin_0%>px; padding: 0px;">Staffing Operations - Selection and Assessment Analyst</H1>
...
<ul>
	<li>Developing behavioral interview guides and advising clients on utilization of guides in the interview process</li>
	<li>Gathering, reporting and analyzing measures of assessment effectiveness, including validation studies, ROI analysis, pass rate and adverse impact reporting requires the use of statistical tools and established research methods</li>
	<li>Developing job-related, legally-defensible screening questions to evaluate minimal qualifications for various jobs</li>
