...
var reqFlashPlayer2 = '" width="258" height="166" alt="This video requires Adobe Flash Player version '+requiredMajorVersion+'. Please download latest version." border="0" \/><\/a>';
...
function playVideo(video,play,pause,stop,ada,mute,ccoc)
{
	...
	{
		mv.innerHTML = getVideo(video,258,166,"javaflash","") + strReplace(strReplace(strReplace(strReplace(getHTMLControl("javaflash",258,22,play,pause,stop,ada,mute,ccoc),"<text>","Video transcript"),"<title>","Video transcript"),"<href>",ada_href),"<anchor>",video.ada_anchor);
...
var flashplayer = new fpvideo("../Includes/pages/rjp/flashplayer_xml20080308.swf",258,166);

var mywork_video;
mywork_video = new fvideo(
					flashplayer.swf_url,
					"../Includes/pages/mywork/MYWORK.xml",
					flashplayer,
					"#vt",
					"../Includes/pages/mywork/thumbnails/mywork_on.jpg",
					"../Includes/pages/mywork/thumbnails/mywork_off.jpg",
					null,
					null
					);
