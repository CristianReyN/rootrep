...
<p style="margin: 0px;"><a href="<%=BAMS_URL%>" title="" target="<%=BAMS_TARGET%>" class="p">Search for current career opportunities<% If BAMS_TARGET = "_blank" Then %><span class="hidden"> Link opens a new window</span><% End If%></a> within Banc of America Merchant Services, LLC.</p>

<h2 class="bacs">Grow Your Career With Us</h2>

<h3 class="bacs">Join our team.</h3>
