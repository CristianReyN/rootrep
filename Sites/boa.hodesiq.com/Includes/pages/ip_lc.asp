		<a name="skipmaincontent"></a><H1 style="margin: 0px <%=right_margin%>px 0px <%=left_margin_0%>px; padding: 0px;">Learning Consultant Internship</H1>
...
<ul style="margin-top: 0px;">
	...
	<li>Assisting with the effective implementation of learning solutions, including:
		<ul style="margin-top: 0px;">
...
<ul style="margin-top: 0px;">
	<li>Conducting performance analysis, assess learning needs within the business and recommend appropriate solutions
	<li>Assisting in consistently improving the learning processes and programs</li>
	<li>Participating in interpreting effectiveness of training and LOB satisfaction</li>
