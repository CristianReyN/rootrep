		<a name="skipmaincontent"></a><H1 style="margin: 0px <%=right_margin%>px 0px <%=left_margin_0%>px; padding: 0px;">Supply Chain Management Associate Program (SCM- MAP)</H1>
		<table width="578" cellpadding="0" cellspacing="0" border="0" summary="">
			<tr valign="top">
				<td width="373" height="100%" valign="top" style="<%=middle_content_padding%>">
<img class="dotdiv" src="../images/clear.gif" width="100%" height="1" alt="" border="0">
<h2 class="h2u" style="margin: 0px 0px 0px 0;">Our Business: Supply Chain Management - MAP Mission Statement:</h2>
...
<ul>
	...
	<li>Technical skills (e.g. Microsoft Office)</li>
