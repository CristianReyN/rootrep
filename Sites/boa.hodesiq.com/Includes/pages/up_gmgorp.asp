		<a name="skipmaincontent"></a><H1 style="margin: 0px <%=right_margin%>px 0px <%=left_margin_0%>px; padding: 0px;">Global Markets Group Operations Rotational Program</H1>
...
<ul>
	...
	<li><b>Global Equity and Futures Operations</b> provides clearance and settlement of all equity and futures products. The mission of this team is to provide a seamless operational platform for trading, sales and underwriting activities by utilizing technology, advanced processes and qualified personnel.</li>
...
<ul>
	<li>Final year candidate from a 4 year college or university</li>
