...
if ( hasRequestedVersion ) {
	document.write('<span class="ada-label">Nathan&acute;s Associate Testimonial Video</span>');
...
<noscript>
<span class="ada-label">Nathan&acute;s Associate Testimonial Video</span>
