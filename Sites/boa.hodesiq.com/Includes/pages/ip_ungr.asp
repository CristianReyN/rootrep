		<a name="skipmaincontent"></a><H1 style="margin: 0px <%=right_margin%>px 0px <%=left_margin_0%>px; padding: 0px;">Global Wealth &amp; Investment Management Undergraduate Internship Program</H1>
...
<br><br>
<u>Bank of America Retirement and Global Wealth &amp; Investment Management Client Solutions</u> group oversees the delivery of a range of services, solutions and capabilities to institutional clients and Bank of America individual customers at various key life stages, with a special emphasis on retirement
</p>
...
<p style="margin: 0px 0px 12px 0px;">
We hire an elite group of associates, pursuing undergraduate degrees in Finance, Economics, and Business.  A proven record of academic success should be accompanied by exceptional communication, critical thinking and relationship building skills, strong business acumen, and a dedication to providing preeminent customer service.  Candidates must be able to work both independently and in tandem with other team members and business partners.  Candidates must also be poised, self-confident, and demonstrate the ability to understand and communicate complex issues in a clear, concise manner.  Students eligible for internships must graduate <b>no sooner</b> then May 2009.
</p>

<h2 class="h2" style="margin: 0px;">Locations</h2>
<p style="margin: 0px 0px 12px 0px;">
Various locations across the United States including but not limited to:<br>
Boston, Massachusetts <span class="middot">&middot;</span> Providence, Rhode Island <span class="middot">&middot;</span> Dallas, Texas <span class="middot">&middot;</span> Concord, California <span class="middot">&middot;</span> Tempe Arizona 
</p>
