		<a name="skipmaincontent"></a><H1 style="margin: 0px <%=right_margin%>px 0px <%=left_margin_0%>px; padding: 0px;">Finance Management Associate Program</H1>
...
<ul>
	<li>An undergraduate or graduate degree in accounting, finance and/or business</li>
	<li>A recommended 12 hours of accounting credit</li>
	<li>Strong academic skills</li>
	<li>Developed critical thinking, leadership, business acumen and relationship building skills</li>
</ul>
