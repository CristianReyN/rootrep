...
<p class="bac">Non-technical Rotation --	Participant joins team responsible for providing an end to end operational support function to a major line of business that falls within the Global Technology and Operations group. Services cover working with the automated monitoring and resolution of standard infrastructure/application events, along with an in-depth proactive infrastructure and capacity assessment program that ensures the ongoing stability of core applications.</p>
<p class="bac">Technical Rotation - Participant joins team responsible for the day to day building of storage within the bank data centers to ensure timely delivery of product and storage services to end user client&#39;s requestors. This team interfaces with other storage teams and server admin teams to coordinate the technical aspects of storage delivery.</p>
</div></div>
