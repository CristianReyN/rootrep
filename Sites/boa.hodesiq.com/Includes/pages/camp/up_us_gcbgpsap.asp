...
<a name="skipmaincontent"></a><h1 class="bac">Global Commercial Banking and Global Product Solutions Analyst Program</h1>
...
<p class="bac">
Throughout the program, analysts are provided a support network, which consists of the program manager, rotation managers and mentors.  An important part of this network also includes former GCIB College Program analysts from previous classes.
</p>
