...
<a name="skipmaincontent"></a><h1 class="bac">Research Analyst</H1>
<h2 class="bac">Our Business</h2>
<p class="bac">
At Bank of America, Research Analysts are aligned by both product (debt or equity) and industry group (healthcare, technology, energy, etc.).  Working alongside some of the most talented professionals in the industry, Research Analysts gain the sector-specific expertise critical to building a career in research, and contribute significantly to the in-depth research we distribute to clients worldwide.
</p>
...
<p class="bac">
As a Research Analyst you will begin your career at Bank of America with an intensive training program.  Initially, you will train with your peers from other lines of business. You will then participate in a program designed specifically for Global Markets Analysts.
</p>
<p class="bac">
...
<p class="bac">
Opportunities are available in New York for both Debt and Equity Research.  General offers are made during the recruiting process by product group – Equity or Debt. Specific industry group assignments are made after initial training and are based on candidate preference and business need.
</p>
