...
<div>
<p class="bac nobr">More than 700 professionals of the award-winning Global Research organization support the company&#39;s institutional sales and trading teams and their clients. Their expertise is at the core of the value delivered to investor clients. Research analysts provide insightful, objective and decisive research designed to enable clients to make informed investment decisions in three primary disciplines:</p>
<ul class="bac">
...
<p class="bac">Analysts are hired and placed directly with a specific team. Placement is determined during the hiring process matching the business needs and the interests/skills of the Analyst. The groups span across country and industry, these include but are not limited to (not all groups exist in all countries):</p>
...
<p class="bac">Research Analysts will work closely with the team and some of the tasks include modeling/analysis, conducting primary research, attend internal/external client meetings. Some responsibilities are conducted regularly (daily, weekly, etc.) while others are longer-term, ad hoc projects over months.</p>
</div></div>
...
<ul class="bac">
	...
	<li>An intensive training program customized for Analysts that prepares you for your placement in Research by simulating actual work assignments, covering quantitative fundamentals, and preparing you for life as an Analyst.</li>
</ul>
...
<div>
<p class="bac">Hong Kong, India and Japan</p>
</div></div>
