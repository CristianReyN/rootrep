...
<p class="bac nobr">Analysts are hired and placed directly with a specific team. Placement is determined during the hiring process matching the business needs and the interests/skills of the Analyst. The various teams include (not all groups exist in all countries):</p>
<ul class="bac">
	<li>Equities</li>
...
<ul class="bac">
	<li>Final year undergraduate/master student, graduating in 2012</li>
	<li>On track to receive a minimum GPA 3.5/4 or minimum 2:1 degree (UK system)</li>
...
<ul class="bac">
	...
	<li>An intensive training program customized for Analysts that prepares you for your placement in Global Markets by simulating actual work assignments, covering quantitative fundamentals, and preparing you for life as an Analyst.</li>
</ul>
