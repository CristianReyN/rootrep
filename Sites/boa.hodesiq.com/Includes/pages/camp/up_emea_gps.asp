...
<a name="skipmaincontent"></a><h1 class="bac">Global Product Solutions</h1>
<h2 class="bac">Our Business</h2>
<p class="bac">
Global Product Solutions (GPS) designs and delivers integrated credit and treasury products to more than 140,000 clients worldwide, including small businesses, middle-market and large companies, multi-nationals, financial institutions and governments. Within GPS is Treasury Services, which provides global payment, liquidity management, trade finance and working capital management solutions.
</p>
...
<p class="bac">
In addition candidates must have obtained or are realistically expecting to obtain a minimum 2:1 degree or equivalent.
</p>
...
<p class="bac">
Throughout your time in Treasury, you can expect a combination of classroom instruction, e-learning modules, case studies and presentations. Throughout the tuition period, analysts have ample opportunities to work closely with professionals and peers across Bank of America. This is a great opportunity to build a network of colleagues from across the company which will prove to be a tremendous resource throughout your career with the bank.
</p>
<p class="bac">
