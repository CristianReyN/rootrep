...
<p class="bac">
<b>Business Associate: </b> Translate business needs into technical requirements, documenting process flows and producing diagrams to ensure understanding amongst all project team members. 
</p>
<p class="bac">
<b>Developer: </b> Provide technical excellence to design, develop and maintain state-of-the-art technology applications utilizing technologies such as Java/EJB&#39;s, C++, .NET and Web services.  Responsible for internal and external client requirements gathering, translating client interactions into technical design specifications, business process reengineering, and partnering with business, product and technology teams across the organization to deliver world class technology solutions.  
</p>
<p class="bac">
<b>Project Management or Systems Support Engineer: </b> Management, administration, and configuration of proprietary applications and 3rd party solutions for application servers, messaging, monitoring, etc. 
</p>
<p class="bac">
<b>Quality Assurance: </b> Combine financial, business, and technical knowledge to develop comprehensive test strategies for internally developed trading systems.  Development of knowledge in all these areas is encouraged and supported. 
</p>
<p class="bac">
<b>Quantitative Associate: </b> Develop sophisticated models, analyses and forecasts supporting pricing and risk management for a range of financial securities. 
</p>
...
<p align="center" style="margin: 6px 0px 24px 0px;"><a target="_blank" href="../Includes/pages/camp/profile/TechnologyAnalyst_Bhavin.pdf" class="p" title="View Bhavin&#39;s profile. Link opens a new window.">View Bhavin&#39;s profile</a></p>
