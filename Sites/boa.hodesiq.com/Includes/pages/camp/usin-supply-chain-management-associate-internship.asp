...
<br>
<h3 class="bacg">Supply Chain Management – MAP Mission Statement:</h3>
<p class="bacg">
...
<ul class="bac">
	...
	<li>Provide subject matter expertise in SCM, supplier evaluation and performance measurement, contract negotiating, quarterly business reviews, total cost of ownership analysis, risk analysis,  compliance</li>
...
<ul class="bac">
	<li>Pursuing Supply Chain Management undergraduate degree</li>
...
<img src="../Includes/pages/camp/profile/SupplyChainManagement_Rachel.jpg" width="205" height="153" alt="Rachel" border="0"><br clear="all">
<p align="center" style="margin: 6px 0px 24px 0px;"><a target="_blank" href="../Includes/pages/camp/profile/SupplyChainManagement_Rachel.pdf" class="p" title="View Rachel&#39;s profile. Link opens a new window.">View Rachel&#39;s profile</a></p>
