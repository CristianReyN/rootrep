...
<p class="bac nobr">Within the Technology Developer and Analyst Program there are five Lines of Business:</p>
<ul class="bac nobull">
	<li><b>Consumer  &amp; Small Business Banking Technology and Operations (CSBB T&amp;O) and Home Loans  &amp; Insurance Technology (HL&amp;IT)</b></li>
	<li><b>Global Commercial and Corporate Banking Technology  &amp; Operations (GCCB T&amp;O)</b></li>
	<li><b>Global Enterprise Functions Technology  &amp; Operations (GEF T&amp;O)</b></li>
	<li><b>Global Markets  &amp; Research Technology  &amp; Operations (GMR T&amp;O)</b></li>
	<li><b>Global Wealth  &amp; Investment Management Technology  &amp; Operations (GWIM T&amp;O)</b></li>
</ul>
<p class="bac">The job profiles for the Technology Developer and Analyst Program:</p>
<br>
<h3 class="bacg">Business Analyst:</h3>&nbsp;<p class="bacg">Translate business needs into technical requirements, documenting process flows and producing diagrams to ensure understanding amongst all project team members.</p>
<br><br>
<h3 class="bacg">Developer:</h3>&nbsp;<p class="bacg">Provide technical excellence to design, develop and maintain state-of-the-art technology applications utilizing technologies such as Java/EJB&#39;s, C++, C#/.NET and Web services. Responsible for internal and external client requirements gathering, translating client interactions into technical design specifications, business process reengineering, and partnering with business, product and technology teams across the organization to deliver world class technology solutions.</p>
<br><br>
<h3 class="bacg">Project Management:</h3>&nbsp;<p class="bacg">Management, administration, and configuration of proprietary applications and 3rd party solutions for application servers, messaging, monitoring, etc.</p>
<br><br>
<h3 class="bacg">Quantitative Associate:</h3>&nbsp;<p class="bacg">Develop sophisticated models, analyses and forecasts supporting pricing and risk management for a range of financial securities.</p>
</div></div>

<div class="expand">
<h2 class="bac"><img class="popen" src="../images/clear.gif" alt="Show information" title="Show information">Overview</h2>
<div>
<p class="bac">The Technology Developer  &amp; Analyst Program is a one-year, global program. This program is designed to facilitate your transition from academia to a professional career and your success at the company. It not only provides program management support, but also structured learning events, training, and networking opportunities. The learning curriculum focuses on business, technical and soft skills. As part of new hire orientation, participants will attend either a 1-week or 3-week training event to provide a strong foundation upon which to build their knowledge and career.</p>
<p class="bac nobr">All Technology Developer and Analysts are called upon to:</p>
<ul class="bac">
