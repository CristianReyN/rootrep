...
<p class="bac">
Global Wealth and Investment Management (GWIM) provides advice-based wealth management services and products to individual clients and businesses. The GWIM business model is based on our network of more than 15,000 financial advisors (FAs) in nearly 700 offices around the world and the one-to-one relationships they develop with their clients. GWIM serves the myriad needs of high-net-worth individuals and small- and mid-sized business owners. Nearly two-thirds of assets under management come from relationships with clients who have investable assets of $1 million or more. We also serve thousands of individuals through employee retirement plans.
</p>
...
<p class="bac">
Analyst Interns participate in a 12 week program based in Singapore providing a unique opportunity and exposure to life in GWIM. Interns are given a true associate experience, as internships mirror fulltime positions and include goal-setting and a formal review process. In addition to learning opportunities there are formal and social opportunities to interact and network with senior colleagues.
</p>
<br>
<H3 class="bac">Placement</H3>
<p class="bac">
GWIM Interns are placed directly with a specific team throughout the internship.  
</p>
<br>
...
<ul class="bac">
	...
	<li>Collaborates with other GWIM interns on a strategic group project specific to the GWIM business</li>
...
<ul class="bac">
	...
	<li>All majors, including liberal arts, finance, and accounting</li>
</ul>
<br>
<H3 class="bac">Experience</H3>
<ul class="bac">
	<li>A track record of superior performance in extracurricular and professional activities 
	<li>Prior relevant internship experience advantageous
</ul>
<br>
