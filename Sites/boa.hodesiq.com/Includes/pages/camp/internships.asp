...
<tr>
	<td valign="top">
		...
		<% If page_section <> "ADA" Then %><H2 class="hidden">Internships U.S.</H2>
		<% ElseIf page_section = "ADA" Then %>
		<table width="100%" cellpadding="0" cellspacing="0" border="0" summary="" style="margin: 18px 0px 0px 0px;">
		<tr>
			<td valign="bottom" nowrap><H2 class="bach" style="margin: 0px 12px 0px 12px;">Internships U.S.</H2></td>
			<td valign="bottom">
	...
	<td valign="top">
		<table width="100%" cellpadding="0" cellspacing="0" border="0" summary="">
			<tr>
				...
				<td width="100%" valign="top">
		<% End If %>
		<% If page_section <> "ADA" Then %><H2 class="hidden">Internships EMEA</H2>
		<% ElseIf page_section = "ADA" Then %>
		...
		<tr>
			...
			<td valign="bottom">
				<H2 class="bac" style="margin: 0px 12px 0px 12px;"><a href="#t1" title="Internships U.S." class="bacb">Internships U.S.</a></H2>
			</td>
		</tr>
		</table>
		<% End If %>
