...
<ul class="bac">
	<li>Performing ad-hoc financial analysis and producing reporting that is distributed to executive leadership and board members</li>
	<li>Analyzing data and output from the bank&#39;s asset/liability models to project the core earnings stream (net interest income) of the corporation and evaluating the interest rate sensitivities of those earnings</li>
	<li>Partnering with the Bank funding traders to raise market based liquidity via the issuance of fed funds, repo, structured notes, and other financial instruments</li>
	<li>Measuring, analyzing, and forecasting the bank&#39;s liquidity position, its primary drivers, and sources of funding</li>
	<li>Participating in dialogue and providing support for rating agencies and fixed income investors</li>
	<li>Working with business partners across the company to ensure consistent implementation of subsidiary governance policies</li>
	<li>Performing validations to ensure the accuracy and completeness of data used in forecasts produced by Corporate Treasury and developing an understanding of products on the bank&#39;s balance sheet</li>
</ul>
<p class="bac">For further information on the Corporate Treasury divisions and CTAP rotation responsibilities, please refer to the following page.</li>
</div></div>
