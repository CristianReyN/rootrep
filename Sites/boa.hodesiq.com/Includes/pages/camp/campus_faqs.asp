...
<p class="bac">Each program has individual requirements. However, to be considered for any program you must be currently enrolled in a college/university or advanced degree program. If you are not currently enrolled in college/university to obtain a degree, you can visit <a href="<% If page_section <> "ADA" Then  %>../overview/<% Else  %>../ada/<% End If %>overview.asp" class="bac" title="Careers Website">www.bankofamerica.com/careers</a> for opportunities available through our corporate/lateral recruiting group.</p>
