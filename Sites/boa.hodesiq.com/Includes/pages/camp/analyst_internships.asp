...
<!-- #include file="../../../includes/career_fit_tool_programs.asp" -->
		...
		<a name="skipmaincontent"></a><H1 class="bac">Analyst Internships</H1>
...
<tr>
	<td valign="top">
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0" summary="">
			<tr>
				<td valign="top">
					<img id="t1" name="t1" class="h" src="../images/camp/t_americas<% If tab = 1 Then %>_a<% End If %>.gif" border="0" alt="Analyst Internships Americas – includes US &amp; Canada" /></td>
				<td valign="top">
					<img id="t2" name="t2" class="h" src="../images/camp/t_emea<% If tab = 2 Then %>_a<% End If %>.gif" border="0" alt="Analyst Internships EMEA" /></td>
				<td valign="top">
					<img id="t3" name="t3" class="h" src="../images/camp/t_asia_pacific<% If tab = 3 Then %>_a<% End If %>.gif" border="0" alt="Analyst Internships Asia Pacific" /></td>
				<td width="100%" background="../images/camp/trtb.gif" valign="top" align="right">
					<img src="../images/camp/trt.gif" border="0" alt="" /></td>
			</tr>
		</table>
...
<tr>
	<td valign="top">
		...
		<% If page_section <> "ADA" Then %>
<H2 class="hidden">Analyst Internships Americas – includes US &amp; Canada</H2>
<a href="#" id="t1h" class="hide-tab" title="Analyst Internships Americas – includes US &amp; Canada">Analyst Internships Americas – includes US &amp; Canada</a>
		<% ElseIf page_section = "ADA" Then %>
		<table width="100%" cellpadding="0" cellspacing="0" border="0" summary="" style="margin: 18px 0px -12px 0px;">
		<tr>
			<td valign="bottom"><H2 class="bach" style="margin: 0px 12px 0px 12px;">Analyst Internships Americas – includes US &amp; Canada</H2></td>
			<td valign="bottom">
				<H2 class="bac" style="margin: 0px 12px 0px 12px;"><a href="#t2" title="Analyst Internships EMEA" class="bacb">Analyst Internships EMEA</a></H2>
				<H2 class="bac" style="margin: 6px 12px 0px 12px;"><a href="#t3" title="Analyst Internships Asia Pacific" class="bacb">Analyst Internships Asia Pacific</a></H2>
			</td>
		</tr>
		</table>
		<% End If %>
		...
		<% For g=1 To UBound(program_groups) Step 1 
			Set program_group = program_groups(g)
				If program_group.Item("is_active") Then
					...
					If program_group_all_programs.Exists(AMERICAS&ANALYST&INTERN) Then
						Set program_group_programs = program_group_all_programs.Item(AMERICAS&ANALYST&INTERN)
...
<tr>
	<td valign="top">
		...
		<% End If %>
		<% If page_section <> "ADA" Then %>
<H2 class="hidden">Analyst Internships EMEA</H2>
<a href="#" id="t2h" class="hide-tab" title="Analyst Internships EMEA">Analyst Internships EMEA</a>
		<% ElseIf page_section = "ADA" Then %>
		<table width="100%" cellpadding="0" cellspacing="0" border="0" summary="" style="margin: 18px 0px -12px 0px;">
		<tr>
			<td valign="bottom"><H2 class="bach" style="margin: 0px 12px 0px 12px;">Analyst Internships EMEA</H2></td>
			<td valign="bottom">
				<H2 class="bac" style="margin: 0px 12px 0px 12px;"><a href="#t1" title="Analyst Internships Americas – includes US &amp; Canada" class="bacb">Analyst Internships Americas – includes US &amp; Canada</a></H2>
				<H2 class="bac" style="margin: 6px 12px 0px 12px;"><a href="#t3" title="Analyst Programs Asia Pacific" class="bacb">Analyst Internships Asia Pacific</a></H2>
			</td>
		</tr>
		</table>
		<% End If %>
	...
	<div class="innerTab">
		<% For g=1 To UBound(program_groups) Step 1 
			Set program_group = program_groups(g)
				If program_group.Item("is_active") Then
					Set program_group_all_programs = program_group.Item("programs")
					If program_group_all_programs.Exists(EMEA&ANALYST&INTERN) Then
						Set program_group_programs = program_group_all_programs.Item(EMEA&ANALYST&INTERN)
						program_group_program_keys = program_group_programs.Keys %>
		<H3 class="bac" style="margin-top: 15px;"><%=program_group.Item("group_name")%></H3>
		<ul class="bac">
					<% For p=0 To UBound(program_group_program_keys) Step 1 
...
<tr>
	<td valign="top">
		...
		<% End If %>
		<% If page_section <> "ADA" Then %>
<H2 class="hidden">Analyst Internships Asia Pacific</H2>
<a href="#" id="t3h" class="hide-tab" title="Analyst Internships Asia Pacific">Analyst Internships Asia Pacific</a>
		<% ElseIf page_section = "ADA" Then %>
		<table width="100%" cellpadding="0" cellspacing="0" border="0" summary="" style="margin: 18px 0px -12px 0px;">
		<tr>
			<td valign="bottom"><H2 class="bach" style="margin: 0px 12px 0px 12px;">Analyst Internships Asia Pacific</H2></td>
			<td valign="bottom">
				<H2 class="bac" style="margin: 0px 12px 0px 12px;"><a href="#t1" title="Analyst Internships Americas – includes US &amp; Canada" class="bacb">Analyst Internships Americas – includes US &amp; Canada</a></H2>
				<H2 class="bac" style="margin: 6px 12px 0px 12px;"><a href="#t2" title="Analyst Internships EMEA" class="bacb">Analyst Internships EMEA</a></H2>
			</td>
		</tr>
		</table>
		<% End If %>
	...
	<div class="innerTab">
		<% For g=1 To UBound(program_groups) Step 1 
			Set program_group = program_groups(g)
				If program_group.Item("is_active") Then
					Set program_group_all_programs = program_group.Item("programs")
					If program_group_all_programs.Exists(ASIA&ANALYST&INTERN) Then
						Set program_group_programs = program_group_all_programs.Item(ASIA&ANALYST&INTERN)
						program_group_program_keys = program_group_programs.Keys %>
		<H3 class="bac" style="margin-top: 15px;"><%=program_group.Item("group_name")%></H3>
		<ul class="bac">
					<% For p=0 To UBound(program_group_program_keys) Step 1 
