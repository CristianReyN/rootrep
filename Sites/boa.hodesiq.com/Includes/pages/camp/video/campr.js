...
var reqFlashPlayer2 = '" width="231" height="131" alt="This video requires Adobe Flash Player version '+requiredMajorVersion+'. Please download latest version." border="0" \/><\/a>';
...
function playVideo(video,play,pause,stop,ada,mute,ccoc)
{
	...
	{
		mv.innerHTML = getVideo(video,231,131,"javaflash","") + strReplace(strReplace(strReplace(strReplace(getHTMLControl("javaflash",231,22,play,pause,stop,ada,mute,ccoc),"<text>","Video transcript"),"<title>","Video transcript"),"<href>",ada_href),"<anchor>",video.ada_anchor);
...
var flashplayer = new fpvideo("../Includes/pages/rjp/flashplayer_xml20080308.swf",231,131);

var tucker_video, arthi_video, malcolm_video, will_video;

tucker_video = new fvideo(
					flashplayer.swf_url,
					"../Includes/pages/camp/video/TUCKER.xml",
					flashplayer,
					"#vt",
					"../Includes/pages/camp/video/thumbnails/tucker_on.jpg",
					"../Includes/pages/camp/video/thumbnails/tucker_off.jpg",
					null,
					null//tucker_cc_video
					);

arthi_video = new fvideo(
					flashplayer.swf_url,
					"../Includes/pages/camp/video/ARTHI.xml",
					flashplayer,
					"#vt",
					"../Includes/pages/camp/video/thumbnails/arthi_on.jpg",
					"../Includes/pages/camp/video/thumbnails/arthi_off.jpg",
					null,
					null
					);
...
will_video = new fvideo(
					flashplayer.swf_url,
					"../Includes/pages/camp/video/WILL.xml",
					flashplayer,
					"#vt",
					"../Includes/pages/camp/video/thumbnails/will_on.jpg",
					"../Includes/pages/camp/video/thumbnails/will_off.jpg",
					null,
					null
					);
