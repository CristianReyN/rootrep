...
<h2 class="bac">Leadership Development (LD) Consultant I - responsibilities include:</h2>
...
<h2 class="bac">Instructional Designer – responsibilities include:</h2>
...
<h2 class="bac">Compensation Consultant I - responsibilities include:</h2>
...
<h2 class="bac">Shared Services Case Manager - responsibilities include:</h2>
...
<h2 class="bac">Shared Services Work Force Communications - responsibilities include:</h2>
...
<ul>
	...
	<li>Demonstrated ability to influence senior executives, establish and maintain collaborative partnerships and provide though leadership</li>
