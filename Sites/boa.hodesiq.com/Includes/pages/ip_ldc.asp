		<a name="skipmaincontent"></a><H1 style="margin: 2px 0px 0px 0px;">Leadership Development Consultant Intern</H1>
...
<p style="margin: 0px 0px 12px 0px;">
Leadership Development (LD) Consultant Intern responsibilities include:
</p>
<ul>
	...
	<li>Designing, developing & delivering leadership development innovations to help clients in all businesses drive objectives</li>
...
<ul>
	...
	<li>Comprehensive knowledge of Organizational Design and Development, Change Management, HR Systems and Executive Development</li>
