...
if ( hasRequestedVersion && diversity_video ) {
	...
	document.write(getVideo(diversity_video,259,166,"javaflash",""));
	document.write(strReplace(strReplace(strReplace(strReplace(getHTMLControl("javaflash",259,22,true,true,true,true,true,true),"<text>","Video transcript"),"<title>","Video transcript"),"<href>",ada_href),"<anchor>",diversity_video.ada_anchor));
	document.write('</div>');
	...
	document.write(strReplace(strReplace(strReplace(strReplace(getHTMLControl("javaflash",259,22,false,false,false,true,false,false),"<text>","Video transcript"),"<title>","Video transcript"),"<href>",ada_href),"<anchor>",diversity_video.ada_anchor));
	document.write('</div>');
...
<noscript>
<a name="video"></a><H2 class="hidden">Diversity and Inclusion Video</H2>
<object type="application/x-shockwave-flash"
data="../Includes/pages/rjp/flashplayer_xml20080308.swf" width="259" height="166" id="javaflash" align="middle">
