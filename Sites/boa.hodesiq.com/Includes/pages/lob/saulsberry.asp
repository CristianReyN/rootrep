...
if ( hasRequestedVersion && saulsberry_video) {
	...
	document.write(getVideo(saulsberry_video.url,"javaflash",""));
	document.write(strReplace(strReplace(strReplace(strReplace(getHTMLControl("javaflash",true,true,true,true,true,true),"<text>","Video transcript"),"<title>","Video transcript"),"<href>",ada_href),"<anchor>",saulsberry_video.ada_anchor));
	document.write('</div>');
