...
if ( hasRequestedVersion && saulsberry_video) {
	...
	document.write(getVideo(saulsberry_video,259,166,"javaflash",""));
	...
	document.write('<a href="Javascript: vo_id();" onmouseover="MM_swapImage(\'dilstart\',\'\',\''+saulsberry_video.thumb_on+'\',1);" onmouseout="MM_swapImgRestore();" onclick="playVideo(saulsberry_video,true,true,true,true,true,true);" title="Play Shawn Saulsberry&acute;s Associate Testimonial Video"><img name="dilstart" style="margin: 0px;" src="'+saulsberry_video.thumb_off+'" alt="Play Shawn Saulsberry&acute;s Associate Testimonial Video" border="0" align="absmiddle"></a>');
	document.write(strReplace(strReplace(strReplace(strReplace(getHTMLControl("javaflash",259,22,false,false,false,true,false,false),"<text>","Video transcript"),"<title>","Video transcript"),"<href>",ada_href),"<anchor>",saulsberry_video.ada_anchor));
	document.write('</div>');
