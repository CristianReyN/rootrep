...
if ( hasRequestedVersion && cambra_video ) {
	...
	document.write('<a href="Javascript: vo_id();" onmouseover="MM_swapImage(\'dilstart\',\'\',\''+cambra_video.thumb_on+'\',1);" onmouseout="MM_swapImgRestore();" onclick="playVideo(cambra_video,true,true,true,true,true,true);" title="Play Gretchen Cambra&acute;s Associate Testimonial Video"><img name="dilstart" style="margin: 0px;" src="'+cambra_video.thumb_off+'" alt="Play Gretchen Cambra&acute;s Associate Testimonial Video" border="0" align="absmiddle"></a>');
	document.write(strReplace(strReplace(strReplace(strReplace(getHTMLControl("javaflash",259,22,false,false,false,true,false,false),"<text>","Video transcript"),"<title>","Video transcript"),"<href>",ada_href),"<anchor>",cambra_video.ada_anchor));
	document.write('</div>');
