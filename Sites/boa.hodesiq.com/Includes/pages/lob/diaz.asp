...
if ( hasRequestedVersion && diaz_video ) {
	...
	document.write('<a href="Javascript: vo_id();" onmouseover="MM_swapImage(\'dilstart\',\'\',\''+diaz_video.thumb_on+'\',1);" onmouseout="MM_swapImgRestore();" onclick="playVideo(diaz_video,true,true,true,true,true,true);" title="Play Anthony Diaz&acute;s Associate Testimonial Video"><img name="dilstart" style="margin: 0px;" src="'+diaz_video.thumb_off+'" alt="Play Anthony Diaz&acute;s Associate Testimonial Video" border="0" align="absmiddle"></a>');
