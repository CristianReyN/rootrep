...
if ( hasRequestedVersion && craig_video ) {
	...
	document.write('<a href="Javascript: vo_id();" onmouseover="MM_swapImage(\'dilstart\',\'\',\''+craig_video.thumb_on+'\',1);" onmouseout="MM_swapImgRestore();" onclick="playVideo(craig_video,true,true,true,true,true,true);" title="Play Craig&acute;s Associate Testimonial Video"><img name="dilstart" style="margin: 0px;" src="'+craig_video.thumb_off+'" alt="Play Craig&acute;s Associate Testimonial Video" border="0" align="absmiddle"></a>');
