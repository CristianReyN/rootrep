...
if ( hasRequestedVersion && craig_video ) {
	...
	document.write(getVideo(craig_video.url,"javaflash",""));
	document.write(strReplace(strReplace(strReplace(strReplace(getHTMLControl("javaflash",false,false,false,true,false,false),"<text>","Video transcript"),"<title>","Video transcript"),"<href>",ada_href),"<anchor>",craig_video.ada_anchor));
	document.write('</div>');
	document.write('<div id="videothumb">');
	document.write('<a href="Javascript: vo_id();" onclick="playVideo(craig_video,false,false,false,true,false,false);"><img style="margin: 0px;" src="'+craig_video.thumb_on+'" alt="" border="0" align="absmiddle"></a>');
