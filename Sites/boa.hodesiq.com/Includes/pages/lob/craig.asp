...
if ( hasRequestedVersion && craig_video ) {
	...
	document.write('<a href="Javascript: vo_id();" onclick="playVideo(craig_video,true,true,true,true,true,true);"><img style="margin: 0px;" src="'+craig_video.thumb_on+'" alt="" border="0" align="absmiddle"></a>');
