...
<img src="../images/adminstration.jpg" width="578" height="166" alt="Explore a career with the Bank of Opportunity." title="Explore a career with the Bank of Opportunity." border="0">
<div class="hidden">Administration. Explore a career with the Bank of Opportunity.</div>
				</td>
			</tr>
...
<a name="skipmaincontent"></a><H1 class="hidden">Administration</H1>
...
<!--<p style="margin: 6px 6px 0px 6px;"><a class="left" onfocus="this.className='left-over';" onblur="this.className='left';" href="../jobsearch.aspx?jobareas=1|1&stateid=-1&cityid=-1&keywords=&SearchPage=Sp">View current jobs in Administration</a></p>-->
<p style="margin: 6px 6px 0px 6px;"><a class="left" onfocus="this.className='left-over';" onblur="this.className='left';" href="../jobsearch.aspx?jobareas=1|1,7&stateid=-1&cityid=-1&keywords=&SearchPage=Sp">View current jobs in Administration</a></p>
<p style="margin: 6px 6px 0px 6px;"><a class="left" onfocus="this.className='left-over';" onblur="this.className='left';" href="../jobsearch.aspx?jobareas=1|2&stateid=-1&cityid=-1&keywords=&SearchPage=Sp">View current jobs in Corporate Executive</a></p>
<p style="margin: 6px 6px 0px 6px;"><a class="left" onfocus="this.className='left-over';" onblur="this.className='left';" href="../jobsearch.aspx?jobareas=1|3&stateid=-1&cityid=-1&keywords=&SearchPage=Sp">View current jobs in Corporate Workplace</a></p>
