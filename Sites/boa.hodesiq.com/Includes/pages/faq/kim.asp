...
<div style="margin: <% If page_section = "ADA" Then %>12<% Else %>0<%End If%>px 0px 0px <%=left_margin_0%>px; width: <% If page_section <> "ADA" Then %><%=(315-right_margin_split-left_margin_0)%>px;<% Else %>100%<%End If%>">
