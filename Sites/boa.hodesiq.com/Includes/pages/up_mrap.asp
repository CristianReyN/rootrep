		<a name="skipmaincontent"></a><H1 style="margin: 0px <%=right_margin%>px 0px <%=left_margin_0%>px; padding: 0px;">Markets Risk Associate Program</H1>
...
<ul>
	...
	<li>Must be able to work independently, with effective time management and business writing skills</li>
...
<br><br>
Geared for young professionals, the MRAP training curriculum is a multi-phase program that complements the hands-on experience associates develop in their day-to-day assignments. Some of the concepts covered during training are: 
</p>
<ul>
