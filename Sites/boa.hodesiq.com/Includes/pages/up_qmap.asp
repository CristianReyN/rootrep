		<a name="skipmaincontent"></a><H1 style="margin: 0px <%=right_margin%>px 0px <%=left_margin_0%>px; padding: 0px;">Quantitative Management Associate Program</H1>
...
<ul>
	<li>Undergraduate or Master's degree in quantitative disciplines such as Engineering, Mathematics, Statistics, Computer Science, Quantitative Finance or Economics</li>
