...
<img src="../images/life_management_benefits.jpg" width="578" height="166" alt="Explore a career with the Bank of Opportunity." title="Explore a career with the Bank of Opportunity." border="0">
<div class="hidden">Life Management Benefits. Explore a career with the Bank of Opportunity.</div>
				</td>
			</tr>
...
<p>Bank&nbsp;of&nbsp;America&acute;s comprehensive Life Management programs are designed to assist associates with many of life's challenges and opportunities:</p>

<H2 class="bac" style="margin: 12px 0px 0px 0px; padding: 0px;">Adoption Reimbursement</H2>
<p style="margin: 6px 0px 0px 0px;">Reimburses up to $8,000 per adopted child upon legal adoption for eligible associates.</p>

<H2 class="bac" style="margin: 12px 0px 0px 0px; padding: 0px;">Child Care Plus<span style="font-size: 0.8em; position: relative; top: -0.6em;">&reg;</span></H2>
<p style="margin: 6px 0px 0px 0px;">Eligible associates can enroll in Child Care Plus, which helps pay for child care expenses incurred while working. Eligible associates can receive up to $240 per month, per child under 5 years of age or up to $205 per month, per child age 5 to under age 13 (under 21, if incapable of self-care). Care can be provided through a licensed facility (like a child care center) or an informal type of care (like a babysitter).</p>

<H2 class="bac" style="margin: 12px 0px 0px 0px; padding: 0px;">Tuition Reimbursement</H2>
<p style="margin: 6px 0px 0px 0px;">The bank reimburses eligible associates up to $5,250 for job-related courses or to fulfill a job-related degree program.</p>

<H2 class="bac" style="margin: 12px 0px 0px 0px; padding: 0px;">LifeCare<span style="font-size: 0.8em; position: relative; top: -0.6em;">&reg;</span></H2>
<p style="margin: 6px 0px 0px 0px;">A free, confidential resource and referral program offering practical advice and support to help associates and their families manage work and personal responsibilities. Includes financial and parenting advice and help finding child- and elder-care resources.</p>

<H2 class="bac" style="margin: 12px 0px 0px 0px; padding: 0px;">Employee Assistance Program (EAP)</H2>
...
<H2 class="bac" style="margin: 12px 0px 0px 0px; padding: 0px;">Auto and Home Insurance</H2>
<p style="margin: 6px 0px 0px 0px;">Provides associates with special group rates on a variety of insurance policies, including those for homes, condominiums, autos, recreational vehicles and rental homes.</p>

<H2 class="bac" style="margin: 12px 0px 0px 0px; padding: 0px;">Commuter Benefit Program</H2>
