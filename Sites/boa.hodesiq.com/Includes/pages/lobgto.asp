...
<ul>
	...
	<li>Maximize technology's role in enabling us to strengthen our competitive advantage in the marketplace</li>
</ul>
...
<ul>
	...
	<li>Bank of America invested over one million technology hours to creating our industry leading network which currently serves and supports:
		<ul type="circle">
			...
			<li>17,000 ATMs
			<li>33 million households
			<li>600 million customer visits per year
			<li>1 billion teller transactions
			<li>1 billion ATM transactions
			<li>250 customer touches every second
			<li>750 mm Customer calls annually</li>
		</ul>
	</li>
</ul>
