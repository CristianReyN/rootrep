...
<div style="position: relative;"><div style="position: absolute; left: 465; top: 141; z-index: 12;">
<a href="<%Response.write href_pre%>explore.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('cc_explore','','../images/cc_explore_over.gif',1)"  onMouseUp="MM_swapImgRestore()" onMouseDown="MM_swapImage('cc_explore','','../images/cc_explore_down.gif',1)" title="Explore. Explore a career with the Bank of Opportunity."><img name="cc_explore" src="../images/cc_explore.gif" alt="Explore. Explore a career with the Bank of Opportunity." width="88" height="22" border="0"></a></div><img src="../images/camprecruiting.jpg" width="578" height="166" alt="Campus Recruiting. Find your ideal opportunity with our College Career Compass." title="Campus Recruiting. Find your ideal opportunity with our College Career Compass." border="0"></div>
...
<%	href_pre = ""
	if page_section <> "ADA" then href_pre = "../learnmore/" %>
<a href="<% Response.write href_pre %>career_compass.asp" class="left2" onfocus="this.className='left2-over';" onblur="this.className='left2';" title="College Career Compass">College Career Compass</a>
...
<p style="margin: 3px 0px 12px 0px;">
Learn about the different areas within Bank of America.
</p>

<a href="http://bankofamerica.com/environment" target="_blank" class="left2" onfocus="this.className='left2-over';" onblur="this.className='left2';" title="Commitment to the environment">Commitment to the environment</a>
<p style="margin: 3px 0px 12px 0px;">
Find out how the bank responds to environmental issues.
</p>

<a href="<% Response.write href_pre %>information_for_parents.asp" class="left2" onfocus="this.className='left2-over';" onblur="this.className='left2';" title="Information for parents">Information for parents</a>
<p style="margin: 3px 0px 12px 0px;">
