...
if ( hasRequestedVersion && analyst_video ) {
	...
	document.write(getVideo(analyst_video,259,180,"javaflash",""));
	document.write(strReplace(strReplace(strReplace(strReplace(getHTMLControl("javaflash",259,22,true,true,true,false,true,false),"<text>","Video transcript"),"<title>","Video transcript"),"<href>",ada_href),"<anchor>",analyst_video.ada_anchor));
	document.write('</div>');
	document.write('<div id="videothumb">');
	document.write('<a href="Javascript: vo_id();" onmouseover="MM_swapImage(\'dilstart\',\'\',\''+analyst_video.thumb_on+'\',1);" onmouseout="MM_swapImgRestore();" onclick="playVideo(analyst_video,true,true,true,false,true,false);"><img name="dilstart" style="margin: 0px;" src="'+analyst_video.thumb_off+'" alt="" border="0" align="absmiddle"></a>');
	document.write(strReplace(strReplace(strReplace(strReplace(getHTMLControl("javaflash",259,22,false,false,false,false,false,false),"<text>","Video transcript"),"<title>","Video transcript"),"<href>",ada_href),"<anchor>",analyst_video.ada_anchor));
	document.write('</div>');
