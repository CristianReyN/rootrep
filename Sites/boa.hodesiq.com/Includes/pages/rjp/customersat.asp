...
if ( hasRequestedVersion && customersat_video ) {
	...
	document.write(strReplace(strReplace(strReplace(strReplace(getHTMLControl("javaflash",259,22,true,true,true,false,true,false),"<text>","Video transcript"),"<title>","Video transcript"),"<href>",ada_href),"<anchor>",customersat_video.ada_anchor));
	document.write('</div>');
	document.write('<div id="videothumb">');
	document.write('<a href="Javascript: vo_id();" onmouseover="MM_swapImage(\'dilstart\',\'\',\''+customersat_video.thumb_on+'\',1);" onmouseout="MM_swapImgRestore();" onclick="playVideo(customersat_video,true,true,true,false,true,false);"><img name="dilstart" style="margin: 0px;" src="'+customersat_video.thumb_off+'" alt="" border="0" align="absmiddle"></a>');
