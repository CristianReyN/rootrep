...
retention_video = new fvideo(
					flashplayer.swf_url,
					"../Includes/pages/rjp/RETENTION.xml",
					flashplayer,
					"#vt",
					"../Includes/pages/rjp/thumbnails/retention_on.jpg",
					"../Includes/pages/rjp/thumbnails/retention_off.jpg",
					null,
					null
					);
customersat_video = new fvideo(
					flashplayer.swf_url,
					"../Includes/pages/rjp/CUSTOMERSAT.xml",
					flashplayer,
					"#vt",
					"../Includes/pages/rjp/thumbnails/customersat_on.jpg",
					"../Includes/pages/rjp/thumbnails/customersat_off.jpg",
					null,
					null
					);
collectors_video = new fvideo(
					flashplayer.swf_url,
					"../Includes/pages/rjp/COLLECTORS.xml",
					flashplayer,
					"#vt",
					"../Includes/pages/rjp/thumbnails/collectors_on.jpg",
					"../Includes/pages/rjp/thumbnails/collectors_off.jpg",
					null,
					null
					);
rjp_video = new fvideo(
					flashplayer.swf_url,
					"../Includes/pages/rjp/RJP.xml",
					flashplayer,
					"#vt",
