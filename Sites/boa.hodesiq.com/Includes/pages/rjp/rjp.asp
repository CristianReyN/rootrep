...
{
	MM_preloadImages('../Includes/pages/rjp/thumbnails/rjp_on.jpg','../Includes/pages/rjp/thumbnails/rjp_off.jpg');
}
...
if ( hasRequestedVersion && rjp_video ) {
	...
	document.write('<a href="Javascript: vo_id();" onmouseover="MM_swapImage(\'dilstart\',\'\',\''+rjp_video.thumb_on+'\',1);" onmouseout="MM_swapImgRestore();" onclick="playVideo(rjp_video,true,true,true,true,true,true);" title="Play Realistic Job Preview - Customer Care Video"><img name="dilstart" style="margin: 0px;" src="'+rjp_video.thumb_off+'" alt="Play Realistic Job Preview - Customer Care Video" border="0" align="absmiddle"></a>');
