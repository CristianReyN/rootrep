...
if ( hasRequestedVersion ) {
	document.write('<span class="ada-label">Marina LanniCucchi&acute;s Associate Testimonial Video</span>');
...
<noscript>
<span class="ada-label">Marina LanniCucchi&acute;s Associate Testimonial Video</span>
