...
if ( hasRequestedVersion ) {
	document.write('<span class="ada-label">Chanel Henderson&acute;s Associate Testimonial Video</span>');
...
<noscript>
<span class="ada-label">Chanel Henderson&acute;s Associate Testimonial Video</span>
