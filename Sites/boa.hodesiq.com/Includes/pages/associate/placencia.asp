...
if ( hasRequestedVersion ) {
	document.write('<a name="video"></a><H2 class="hidden">Patricia Placencia&acute;s Associate Testimonial Video</H2>');
	document.write(Placencia_video);
	document.write(strReplace(strReplace(strReplace(html_control,"<text>","Video transcript"),"<title>","Video transcript"),"<href>","<%=ada_href %>"));
	createStopAudio();
} else {
	document.write(reqFlashPlayer+'placencia.jpg'+reqFlashPlayer2);
}
</script>
<noscript>
