...
if ( hasRequestedVersion && placencia_video ) {
	...
	document.write('<a href="Javascript: vo_id();" onmouseover="MM_swapImage(\'dilstart\',\'\',\''+placencia_video.thumb_on+'\',1);" onmouseout="MM_swapImgRestore();" onclick="playVideo(placencia_video,true,true,true,true,true,true);" title="Play Patricia Placencia&acute;s Associate Testimonial Video"><img name="dilstart" style="margin: 0px;" src="'+placencia_video.thumb_off+'" alt="Play Patricia Placencia&acute;s Associate Testimonial Video" border="0" align="absmiddle"></a>');
