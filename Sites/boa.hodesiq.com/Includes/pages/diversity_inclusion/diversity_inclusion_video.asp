...
{
	MM_preloadImages('../Includes/pages/diversity_inclusion/thumbnails/diversity_inclusion_on.gif','../Includes/pages/diversity_inclusion/thumbnails/diversity_inclusion_off.gif');
}
