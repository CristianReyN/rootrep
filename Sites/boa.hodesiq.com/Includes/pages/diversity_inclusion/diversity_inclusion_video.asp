...
{
	MM_preloadImages('../Includes/pages/diversity_inclusion/thumbnails/diversity_inclusion_on.jpg','../Includes/pages/diversity_inclusion/thumbnails/diversity_inclusion_off.jpg');
}
...
if ( hasRequestedVersion && diversity_inclusion_video ) {
	...
	document.write('<a href="Javascript: vo_id();" onmouseover="MM_swapImage(\'dilstart\',\'\',\''+diversity_inclusion_video.thumb_on+'\',1);" onmouseout="MM_swapImgRestore();" onclick="playVideo(diversity_inclusion_video,true,true,true,true,true,false);" title="Play Global Diversity and Inclusion Video"><img name="dilstart" style="margin: 0px;" src="'+diversity_inclusion_video.thumb_off+'" alt="Play Global Diversity and Inclusion Video" border="0" align="absmiddle"></a>');
