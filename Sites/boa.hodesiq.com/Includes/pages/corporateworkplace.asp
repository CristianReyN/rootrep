...
<p style="margin: 6px 6px 0px 6px;"><a class="left" onfocus="this.className='left-over';" onblur="this.className='left';" href="../jobsearch.aspx?jobareas=2|3&stateid=-1&cityid=-1&keywords=&SearchPage=Sp">View current jobs in Corporate Workplace</a></p>
</div>
...
<p style="margin: 12px <%=right_margin_split%>px 0px <%=left_margin_0%>px;">
...
<p style="margin: 12px <%=right_margin_split%>px 0px <%=left_margin_0%>px;">
Read more about our <a href="<% If page_section <> "ADA" Then %>../corporateworkplace/cw_teams.asp<% Else %>../ada/cw_teams.asp<%End If%>" class="p" title="Corporate Workplace teams">Corporate Workplace teams</a>.
</p>

<p style="margin: 12px <%=right_margin_split%>px 0px <%=left_margin_0%>px;">
<a href="<% If page_section <> "ADA" Then %>../corporateworkplace/cw_vision.asp<% Else %>../ada/cw_vision.asp<%End If%>" class="p" title="Our Vision Statement">Our Vision Statement</a>
</p>
