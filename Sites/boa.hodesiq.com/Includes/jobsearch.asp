...
<optgroup label="Communications">
	<option value="3|-1" OptionGroup="Communications">All Communications</option>
...
<optgroup label="Finance">
	<option value="4|-1" OptionGroup="Finance">All Finance</option>
...
<optgroup label="Human Resources">
	<option value="5|-1" OptionGroup="Human Resources">All Human Resources</option>
	<option value="5|7" OptionGroup="Human Resources">Learning &amp; Org Effectiveness</option>
</optgroup>
<optgroup label="Operations">
	<option value="6|-1" OptionGroup="Operations">All Operations</option>
...
<optgroup label="Risk Evaluation">
	<option value="7|-1" OptionGroup="Risk Evaluation">All Risk Evaluation</option>
</optgroup>
<optgroup label="Sales">
	<option value="8|-1" OptionGroup="Sales">All Sales</option>
	<option value="8|20" OptionGroup="Sales">Consumer banking</option>
</optgroup>
<optgroup label="Technology">
	<option value="9|-1" OptionGroup="Technology">All Technology</option>
</optgroup>
</select>
							</td>
						</tr>
