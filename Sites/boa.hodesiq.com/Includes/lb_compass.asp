...
'				q,question number,question title,question weight
	...
	call addQuestion(group,q)
	call createQuestion(q,25,"A good communicator","I tend to think of myself as a good communicator",2)
	call addQuestion(group,q)
