...
'				q,question number,question title,question weight
	...
	call createQuestion(q,24,"A self-starter/self-motivator","I tend to think of myself as a self-starter/self-motivator",1)
	call addQuestion(group,q)
	call createQuestion(q,25,"A good communicatior","I tend to think of myself as a good communicatior",1)
	call addQuestion(group,q)
	call createQuestion(q,26,"Detail-oriented","I tend to think of myself as detail-oriented",1)
	call addQuestion(group,q)
	call createQuestion(q,27,"Entrepreneurial","I tend to think of myself as entrepreneurial",1)
	call addQuestion(group,q)
	call createQuestion(q,28,"Flexible","I tend to think of myself as flexible",1)
	call addQuestion(group,q)
	call createQuestion(q,29,"A leader","I tend to think of myself as a leader",1)
	call addQuestion(group,q)
	
	call addQuestionGroup(page,group)
	
	call createQuestionGroup(group,4,"I work most effectively in the following atmosphere:","radio",1)
	call createQuestion(q,30,"One with clearly defined with specific goals and structured schedules","I work most effectively in the atmosphere with clearly defined with specific goals and structured schedules",1)
	call addQuestion(group,q)
	call createQuestion(q,31,"An environment which encourages an opportunity to be entrepreneurial and/or innovative","I work most effectively in the environment which encourages an opportunity to be entrepreneurial and/or innovative",1)
	call addQuestion(group,q)
