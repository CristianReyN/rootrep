			...
			if ( a_name == "" || a_name == "undefined" )
			{
				...
				if ( maybe_name == "" )
				{
					...
					if ( maybe_name == "" )
					{
						...
						if ( this.href.indexOf('mailto') != -1 ) html_to_name = "mailto_" + strReplace(strReplace(a_html, "@", "_"), ".", "_");
 ...
 function CMName(maybe_name)
 {
 	if(maybe_name)
	{
		...
		if ( maybe_name != "" )
		{
			...
			maybe_name = strReplace(strReplace(strReplace(strReplace(strReplace(strReplace(maybe_name, "  ", " "), "  ", " "), "- ", "-"), " -", "-"), "_  ", "_"), " _ ", "_");
			//replace space with _
			maybe_name = strReplace(strReplace(strReplace(strReplace(strReplace(maybe_name, "_-", "_"), "-_", "_"), "--", "_"), "__", "_"), " ", "_");
		}
	}
	else maybe_name = "";
	return maybe_name;
