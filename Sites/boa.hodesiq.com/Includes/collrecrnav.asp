...
<a href="http://bankofamericacareers.com/college/" target="_blank" title="Campus Calendar. Find an event."><img src="../images/boa_calendar.jpg" width="205" height="80" border="0" style="margin: 12px 0px 0px 0px;" alt="Campus Calendar. Find an event."></a>
...
<% If fpage <> "information_for_parents" Then %>
