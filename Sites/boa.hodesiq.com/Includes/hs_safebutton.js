...
function create_safebutton(text, href, onclick_evt, onmouseover_evt, onmouseout_evt, tabindex, title, _container, _name) {
...
function create_safebutton_tmp(text, href, onclick_evt, onmouseover_evt, onmouseout_evt, tabindex, title, _container) {
    ...
    if (!document.getElementById("dialog")) { // If dialog does not exist, write button
