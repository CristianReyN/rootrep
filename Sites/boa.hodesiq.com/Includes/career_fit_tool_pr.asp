...
'				answer, answer number, answer title, answer label
	...
	call addAnswer(question,a)
	call createAnswer(a,13,"Building and developing relationships with external customers (audiences)","My preferred work environment is: Building and developing relationships with external customers (audiences)")
	call addAnswer(question,a)
	call addQuestion(page,question)
	Set pages(4) = page
