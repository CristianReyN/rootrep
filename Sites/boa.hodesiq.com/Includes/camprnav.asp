...
<%		End if %>
<%		if r2 then %>
	<a href="../CampusEvents.aspx" title="Campus Events. Meet Our Recruiters » "><img src="../images/camp/b_evc.jpg" width="185" height="51" alt="Campus Events. Meet Our Recruiters » " border="0" style="margin: 0px 0px 5px 0px;" align="top"></a><br clear="all">
<%		End if %>
<%		if r3 then %>
