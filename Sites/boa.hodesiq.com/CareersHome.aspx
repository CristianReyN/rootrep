     ...
     <div class="top325">
        <div class="column" id="column05">
	        <ul>
	            ...
	            <li><a href="staffingevents/staffingevents.asp"  tabindex="51" id="item39" onblur="trnsfrfocus();" name="staffing_events_topnav"><span class="hidden">Topics </span>Staffing Events</a></li>
	        </ul>
        </div>
    </div>
    <div class="bottom325"></div>
    ...
    function trnsfrfocus() {
        ...
        document.getElementById('item153').focus();
            ...
            <div id="slidearea">
                <div id="rotator"> 
                <ul>
                    <li id="slide1" title="Slide 1 Job Areas" class="show"  style="background: url(homepage-redesign/images/slide/p1.jpg) top left no-repeat;"><div class="text-controls"><div class="contents"><p><img src="homepage-redesign/images/slide/ttl1.png" alt="" border="0" style="background:none;" /><br />If you want to work with consumers, investors or institutions, in a career that goes from customer care, sales and finance to HR, technology or risk management &mdash; a career with Bank of America may set opportunity in motion for you. <a href="areasoftalent/areasoftalent.asp" id="item153" tabindex="53" title="Explore our Job Areas now" name="Explore_our_Job_Areas_now"><span class="hidden">Explore our Job Areas now.</span>Explore our Job Areas now.</a></p></div></div><a name="JobAreas"></a><a href="#JobAreas" name="Show_JobAreas_Slide"><span class="hidden">Slide 1 Job Areas</span></a></li>              
                    <li id="slide2" title="Slide 2 Financial Advisors" style="background: url(homepage-redesign/images/slide/p2.jpg) top left no-repeat;"><div class="text-controls"><div class="contents"><p><img src="homepage-redesign/images/slide/ttl2.png" alt="" border="0" style="background:none;" /><br />Opportunity awaits those who seek constant challenge, and remarkable rewards. <a href="financialadvisor/" id="item155" tabindex="55" title="Join our team, learn more about Financial Advisors" name="Join_our_team_learn_more_about_Financial_Advisors"><span class="hidden">Join our team, learn more about Financial Advisors</span>Join our team</a> of Financial Advisors at Bank of America, developing and delivering sophisticated solutions that help our affluent clients simplify, manage and maximize their financial goals.</p></div></div><a name="FinancialAdvisors"></a><a href="#FinancialAdvisors" name="Show_FinancialAdvisors_Slide"><span class="hidden">Slide 2 Financial Advisors</span></a></li>
                    <li id="slide3" title="Slide 3 Students" style="background: url(homepage-redesign/images/slide/p3.jpg) top left no-repeat;"><div class="text-controls"><div class="contents"><p><img src="homepage-redesign/images/slide/ttl3.png" alt="" border="0" style="background:none;" /><br /><a href="campus.aspx" id="item157" tabindex="57" title="Join our team, learn more about Student programs" name="Join_our_team_learn_more_about_Student_programs"><span class="hidden">Join our team, learn more about Student programs</span>Join our team<span> learn more about Student programs </span></a>&nbsp;and we&rsquo;ll open your career path and give you new opportunities to take the possible and make it real. You&rsquo;ll receive training, mentorship and support to boost your aspirations to a global level. And, as part of the world&rsquo;s leading financial institution, you can create the kind of opportunity that generates greater opportunity and bigger impact than you ever imagined.</p></div></div><a name="Students"></a><a href="#Students" name="Show_Studens_Slide"><span class="hidden">Slide 3 Students</span></a></li>                    
                    <li id="slide4" title="Slide 4 Locations" style="background: url(homepage-redesign/images/slide/p4.jpg) top left no-repeat;"><div class="text-controls"><div class="contents"><p><img src="homepage-redesign/images/slide/ttl4.png" alt="" border="0" style="background:none;" /><br />With positions available across the Americas, Europe, Middle East, Africa (EMEA) and Asia&mdash;Pacific, there is literally a world of opportunity with us. More than 250,000 employees worldwide have already discovered their ideal career at Bank of America. We invite you to <a href="locations/" id="item159" tabindex="59" title="Learn about our locations" name="Learn_about_our_locations"><span class="hidden">Learn about our locations</span>learn more about us.<span> Learn about our locations. </span></a></p></div></div><a name="Locations"></a><a href="#Locations" name="Show_Locations_Slide"><span class="hidden">Slide 4 Locations</span></a></li>
                    <li id="slide5" title="Slide 5 Military" style="background: url(homepage-redesign/images/slide/p5.jpg) top left no-repeat;"><div class="text-controls"><div class="contents"><p><img src="homepage-redesign/images/slide/ttl5.png" alt="" border="0" style="background:none;" /><br />Bring your skills to a place where teamwork, trust and accountability mean as much to us as they do to you.  Bank of America is proud to be regularly recognized by GI Jobs, Military Edge, and others, as a top &ldquo;military-friendly&rdquo; employer. Join thousands of other veterans here, and <a href="military/" id="item161" tabindex="61" title="Discover why veterans consider us military-friendly" name="Discover_why_veterans_consider_us_military_friendly"><span class="hidden">Discover why veterans consider us military-friendly</span>discover why.<span> veterans consider us military-friendly .</span></a></p></div></div><a name="Military"></a><a href="#Military" name="Show_Military_Slide"><span class="hidden">Slide 5 Military</span></a></li>
                </ul>
                <div>
