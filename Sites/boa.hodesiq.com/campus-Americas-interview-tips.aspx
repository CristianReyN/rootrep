<%@ Page Title="Bank of America | Careers | Campus Recruiting | How to Apply | Americas Interview Tips" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-Americas-interview-tips.aspx.cs" Inherits="campus_Americas_interview_tips" %>
...
<div id="maincontent"> 
                <div id="article"> 
                  ...
                  <p>We're looking forward to meeting you. To help you better 
                    prepare for our conversation, we'd like to offer you a few 
                    interview tips. At the end of this list, you'll also find 
                    our recommendations for books that can provide you with additional 
                    guidance.</p>
                  <h2 class="questions">Research our company in depth</h2>
<ul>
...
<h2 class="questions">Identify your skills</h2>
<ul>
...
<h2 class="questions">Prepare experiences and examples</h2>
<ul>
<li>Think about some actual stories you can tell from previous work experiences to back up your claims with evidence</li>
...
<h2 class="questions">Present a polished appearance</h2>
<ul>
<li>Dress professionally</li>
<li>Make sure your cell phone/mobile/Blackberry is turned off in advance of your interview</li>
</ul>

<h2 class="questions">Get directions in advance and be clear that you understand them</h2>
<ul>
...
<h2 class="questions">Get enough rest</h2>
<ul>
<li>Get a good night's sleep so you'll be as physically, psychologically and emotionally at your best for the interview</li>
</ul>

<h2 class="questions">Bring your resume or CV</h2>
<ul>
<li>Bring several copies of your resume or CV</li>
</ul>

<h2 class="questions">Make a solid first impression</h2>
<ul>
...
<h2 class="questions">Prepare questions</h2>
<ul>
...
<li>Be original &ndash; don't ask the obvious questions</li>
</ul>

<h2 class="questions">Practice closing your interview</h2>
<ul>
...
<h2 class="questions">Be ready for surprises</h2>
<ul>
...
<h2 class="questions">Additional Resources</h2>

<p>Get a Job!. Interview Survival Skills for College Students by John R. Cunningham</p>

<p>101 Great Answers to the Toughest Questions by Ronald W. Fry</p>

<p>Job Interviews for Dummies by Joyce Layne Kennedy</p>

<p>The Interview Rehearsal Book by Deb Gottesman</p>

<p>Competency-based Interviews: Master the Tough New Interview Style and Give Them the Answers that will Win You the Job by Robin Kessler</p>

<p>Interview Skills that Win the Job: Simple Techniques for Answering all the Tough Questions by Michael Spiropoulos</p>
                </div>
                <div id="aside"> 
                  ...
                  <a href="CampusEvents.aspx?region=1" name="Campus_Event"><img src="images/campus/btn-campus-events.jpg" width="179" height="66" alt="Campus Events: Let's meet soon." /></a> 
...
<script language='javascript1.1' type='text/javascript'>
    //<!—
    cmCreatePageviewTag('career:Content:Campus_Recruiting;campus-americas-interview-tips', null, null, 'career:Content:Campus_Recruiting', false, false, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null);
    //-->
</script>
</asp:Content>
