<%@ Page Language="C#" MasterPageFile="~/MasterPage_French.master" AutoEventWireup="true"
    CodeFile="fr_canada_benefits.aspx.cs" Inherits="fr_canada_benefits" Title="Untitled Page" %>

<asp:Content ID="Image" ContentPlaceHolderID="Image" runat="Server">
    <img src="images/Banners_Canada_Benefits.jpg" width="578" height="166" alt="Canada Explorez la possibilité de faire carrière dans une Banque de possibilités  "
...
<asp:Content ID="Main" ContentPlaceHolderID="Main" runat="Server">
    ...
    <h1 class="hidden">
        Global Carri&egrave;res - Canada Avantages</h1>
...
<script language='javascript1.1' type='text/javascript'>
    //<!—
    cmCreatePageviewTag('career:Tool:Regions;fr-canada-benefits', null, null, 'career:Tool:Regions', false, false, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null);
    //-->
</script>
</asp:Content>
