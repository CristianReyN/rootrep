...
fpage = "usfs-consumer-mba-program-product-track"
standart_href = "../campusrecruiting/usfs-consumer-mba-program-product-track.asp"
page_self = "../ada_camp/usfs-consumer-mba-program-product-track.asp"
...
<!-- #include file="../includes/pages/camp/usfs-consumer-mba-program-product-track.asp" -->
<br><br>
<!-- Body-->
	</td>
</tr>
