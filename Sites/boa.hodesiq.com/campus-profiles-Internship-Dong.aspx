<%@ Page Title="Bank of America | Careers | Campus Recruiting | Meet Our People | Dong's Internship Profile" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-profiles-Internship-Dong.aspx.cs" Inherits="campus_profiles_Internship_Dong" %>
...
<div id="profiles"> 
  ...
  <div id="article"> 
    <div class="content-profiles"> <img src="images/campus/profiles/photo-Dong.jpg" width="167" height="168" alt="Dong" /> 
      <div class="info-profiles"> 
        <h2>Dong</h2>
        <p>Associate</p>
        <p>Corporate and Investment Banking Associate Program, Hong Kong</p>
        <h3>Education:</h3>
        <p>Undergrad &ndash; Tsinghua University</p>
    ...
    <p>Get to know as many Bank of America representatives as possible and learn 
      their unique stories and experiences. </p>
    ...
    <p>I used to be a Summer Associate with Merrill Lynch Investment Banking based 
      in Hong Kong in 2007. The experiences were fantastic &ndash; it was a fresh 
      start for my career in banking and I also built up a sound foundation when 
      I came back for a full-time position. More importantly, I also made many 
      friends, truly lifetime friends. </p>
    <h4>What other activities do you enjoy outside of your work day?</h4>
    <p>I recently joined a one-day volunteer activity with 20 other associates 
      from various divisions of Bank of America Merrill Lynch Hong Kong to help 
      Crossroads Global Distribution, a not-for-profit organization which takes 
      Hong Kong's quality superseded goods and redistributes them to people in 
      need, locally and internationally. We helped them repaint their logistic 
  ...
  <div id="aside"> <a href="campusrecruiting/career_fit_tool.asp"><img src="images/campus/btn-careerfinder.jpg" width="179" height="66" alt="Career Finder: Come as you are. We've got a career to fit." /></a> 
    ...
    <ul>
      ...
      <li><a href="campus-profiles-Internship-Gabriel.aspx">Next profile</a></li>
  </div>
  <div id="red-footer"> 
...
<script language='javascript1.1' type='text/javascript'>
    //<!—
    cmCreatePageviewTag('career:Content:Campus_Recruiting;campus-profiles-internship-dong', null, null, 'career:Content:Campus_Recruiting', false, false, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null);
    //-->
</script> 
</asp:Content>
