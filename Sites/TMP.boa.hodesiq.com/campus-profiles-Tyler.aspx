<%@ Page Title="" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-profiles-Tyler.aspx.cs" Inherits="campus_profiles_Tyler" %>
...
<div id="profiles"> 
  ...
  <div id="article"> 
    <div class="content-profiles"> <img src="images/campus/profiles/photo-tyler.jpg" width="171" height="173" alt="Tyler" /> 
      <div class="info-profiles"> 
        <h2>Tyler</h2>
        <p>Associate</p>
        <p>Global Capital Markets Analyst Program, New York, NY</p>
        <h3>Education:</h3>
        <p>Undergrad &ndash; Middlebury College</p>
    ...
    <p>I am an associate in the Equity Capital Markets group where I focus on 
      ...
      to institutional investors in the U.S.</p>
    <h4>What is the most challenging part of your job?</h4>
    <p>The most challenging part of my job is to consistently achieve a balanced 
      outcome in which both issuers and investors, who often have conflicting 
      interests, are satisfied with the end result.</p>
    <h4>I remain at Bank of America because&#133;?</h4>
    <p>In my opinion, the financial services platform that has been created here 
      at Bank of America Merrill Lynch is without rival.</p>
    <h4>What advice would you give to someone considering an opportunity at Bank 
      of America?</h4>
    <p>Know what you're looking for in a career before you pursue any opportunity 
  ...
  <div id="aside"> <a href="campus-Americas-find-your-fit.aspx"><img src="images/campus/btn-careerfinder.jpg" width="179" height="66" alt="Career Finder: Come as you are. We've got a career to fit." /></a> 
    ...
    <ul>
      ...
      <li><a href="campus-Americas-associate-profiles.aspx">Next profile</a></li>
      <li><a href="campus-profiles-Rachna.aspx">Previous profile</a></li>
    </ul>
  </div>
  <div id="red-footer"> 
