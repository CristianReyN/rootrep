<%@ Page Title="" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-profiles-Pepe.aspx.cs" Inherits="campus_profiles_Pepe" %>
...
<div id="profiles"> 
  ...
  <div id="article"> 
    <div class="content-profiles"> <img src="images/campus/profiles/photo-pepe.jpg" width="171" height="173" alt="Pepe" /> 
  ...
  <div id="aside"> <a href="campus-Americas-find-your-fit.aspx"><img src="images/campus/btn-careerfinder.jpg" width="179" height="66" alt="Career Finder: Come as you are. We've got a career to fit." /></a> 
    ...
    <ul>
      ...
      <li><a href="campus-profiles-Priya.aspx">Next profile</a></li>
      <li><a href="campus-profiles-Nisheet.aspx">Previous profile</a></li>
    </ul>
  </div>
  <div id="red-footer"> 
