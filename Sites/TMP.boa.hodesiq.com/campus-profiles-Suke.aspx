<%@ Page Title="Bank of America | Careers | Campus Recruiting | Meet Our People | Suke's Profile" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-profiles-Suke.aspx.cs" Inherits="campus_profiles_Suke" %>
    ...
    <div id="article">
        ...
        <div class="content-profiles">
            ...
            <img src="images/campus/profiles/photo-SukeChan.jpg" width="167" height="168" alt="Bhavin" />
                ...
                <p>Technology Analyst Program &ndash; ET&amp;D, Hong Kong</p>
                
                <h3>Education:</h3>
                <p>Undergrad &ndash; University of California, Berkeley</p>
                <p>Degree &ndash; B.S., Computer Science</p>
                </div>
        </div>
...
various vendors, trading technologies and also connectivity to stock
exchanges in Asia Pacific. We support both developers and users.</p>

<h4>What is the most challenging part of your job?</h4>
<p>My job duties require timely response because the stock market
will not wait. Short turnaround time is always expected from the
business to deploy new products or to recover from outages.
With the vast amount of services we support, efficiency and
good communication skills are key.</p>

<h4>What is the best thing about living and working in your location?</h4>
<p>Living in one of the world's fastest growing economies, you will
...
professionals will often get more exposure and responsibilities.</p>
    ...
    <div id="aside">
        ...
        <li><a href="campus-Americas-analyst-profiles.aspx">Back to profile list</a></li>
      	<li><a href="campus-Americas-analyst-profiles.aspx">Next profile</a></li>
      	<li><a href="campus-profiles-Stanley.aspx">Previous profile</a></li>
        </ul>
