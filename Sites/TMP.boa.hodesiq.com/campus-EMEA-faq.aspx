...
<div id="maincontent"> 
                <div id="article"> 
                  <h1>Campus Frequently Asked Questions</h1>
                  <p>You've done your research, and now you're ready to take the 
                    next step and begin the application process. You're in the 
                    right place. Before you dive in, please take a look at our 
                    <a href="CampusEvents.aspx?region=2">campus events page</a> 
                    to see if we'll be visiting your campus. (We'd love to meet 
                    you in person.) Otherwise, please use the tabs below to narrow 
                    your geographical focus and follow the instructions. We look 
                  ...
                  <h3>When does Bank of America Merrill Lynch recruit students 
                    for full-time opportunities?</h3>
                  ...
                  <h3>When does Bank of America Merrill Lynch recruit students 
                    for internship opportunities?</h3>
                  ...
                  <h3>How can I decide what programme is best for me?</h3>
                  <p>We have created a <a href="#">guided questionnaire</a> on the campus recruiting 
                  ...
                  <h3>Can I apply to multiple offices and divisions?</h3>
                  <p>No &ndash; you may only apply to one office and one division.</p>
                  <h3>Are positions available globally, and who is eligible to 
                    fill them?</h3>
                  ...
                  <h3>Can I defer an offer?</h3>
                  <p>No. Bank of America Merrill Lynch does not offer you the 
                    chance to defer.</p>
                  <h3>If I applied last year, can I apply again this year?</h3>
                  ...
                  <h3>Can I apply if I require a work permit?</h3>
                  <p>Yes.</p>
                  <h3>I graduated last year &ndash; am I eligible to apply for a Summer 
                    Internship?</h3>
                  <p>No &ndash; you must be in your penultimate year of study to be 
                    eligible to apply for a summer internship.</p>
                  <h3>If I apply for a position in the Americas or Asia Pacific 
                  ...
                  <h3>When will I hear from Bank of America Merrill Lynch following 
                    submission of my application?</h3>
                  <p>We receive a very high volume of applications and endeavour 
                    ...
                    application.</p>
                  <h3>Do you offer internships at other times of the year than 
                    summer?</h3>
                  ...
                  <h3>Can I make changes to my application once I have submitted 
                    it?</h3>
                  ...
                  <h3>I would like to make changes to my application, but have 
                    already submitted it?</h3>
