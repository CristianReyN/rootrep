<%@ Page Title="Bank of America | Careers | Campus Recruiting | Meet Our People | John-William's Profile" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-profiles-John-William.aspx.cs" Inherits="campus_profiles_John_William" %>
...
<div id="profiles"> 
  ...
  <div id="aside"> <a href="campus-Americas-find-your-fit.aspx"><img src="images/campus/btn-careerfinder.jpg" width="179" height="66" alt="Career Finder: Come as you are. We've got a career to fit." /></a> 
    ...
    <ul>
      ...
      <li><a href="campus-profiles-Jordan.aspx">Next profile</a></li>
      <li><a href="campus-profiles-John.aspx">Previous profile</a></li>
    </ul>
  </div>
  <div id="red-footer"> 
