...
you the opportunity to create real impact right out of the gate.</p>
  ...
  <div id="aside"> 
            ...
            <% if (Request.QueryString["vts"]=="chris") {%>
               ...
               <p><a href="campus-EMEA-analyst-profiles.aspx">View Chris's Video</a>
	...
	<tr>
		...
		<td width="100%" height="22" align="center" nowrap><a href="campus-EMEA-analyst-profiles.aspx?vts=chris" class="btn1">Video transcript</a></td>
		<td nowrap>
     ...
     <%}%>                   
            ...
            <p><a href="campus-EMEA-analyst-profiles.aspx">View Erin's Video</a></p>
            </div>
	...
	<tr>
		...
		<td width="100%" height="22" align="center" nowrap><a href="campus-EMEA-analyst-profiles.aspx?vts=erin" class="btn1">Video transcript</a></td>
		<td nowrap>
