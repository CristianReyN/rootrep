<%@ Page Title="Bank of America | Careers | Campus Recruiting | Americas How to Apply" Language="C#" MasterPageFile="~/BOAmaster.master" AutoEventWireup="true" CodeFile="campus-Americas-how-to-apply.aspx.cs" Inherits="campus_Americas_how_to_apply" %>
...
<div id="maincontent"> 
  ...
  <div id="article">
				 ...
				 <p>You've done your research, and now you’re ready to take the next step and begin the application process. You’re in the right place. Before you dive in, please take a look at our campus events page [link] to see if we’ll be visiting your campus. (We’d love to meet you in person.) Otherwise, please use the tabs below to narrow your geographical focus and follow the instructions. We look forward to hearing from you.</p>

<h3>Apply in the U.S.</h3>
